...
`,du=({isModalOpen:n,closeModal:r})=>{const[t,e]=D.useState(50),[a,s]=D.useState(""),{id:o,ml:i,time:c}=ge(Ro),l=He(),d=()=>{e(w=>w+50)},p=()=>{t>=50&&e(w=>w-50)},m=w=>{s(w)},h=w=>{w.preventDefault();const b={time:a,ml:t};console.log(b),l(Fa({id:o,data:b}))},y=w=>{const b=parseInt(w.target.value);e(b)};return f.jsx(f.Fragment,{children:n&&f.jsx(Mn,{onClose:r,children:f.jsxs(uu,{children:[f.jsxs("div",{className:"topline",children:[f.jsx("h2",{children:"Edit the entered amount of water"}),f.jsx(kn,{className:"close",onClick:r})]}),f.jsxs("span",{className:"amount",children:[i,"ml"]}),c,f.jsx("p",{children:"Correct entered data:"}),f.jsxs("form",{onSubmit:h,children:[f.jsxs("label",{children:["Amount of water:",f.jsxs("div",{className:"counter",children:[f.jsx("button",{className:"counterBtn",type:"button",onClick:d,children:f.jsx(Yn,{})}),f.jsxs("span",{className:"waterAmount",children:[t,"ml"]}),f.jsx("button",{className:"counterBtn",type:"button",onClick:p,children:f.jsx(In,{})})]})]}),f.jsxs("label",{children:["Recording time:",f.jsx(Ca,{className:"input",selected:a,onChange:w=>m(w),showTimeSelect:!0,showTimeSelectOnly:!0,timeFormat:"HH:mm",dateFormat:"HH:mm"})]}),f.jsxs("label",{children:["Enter the value of the water used:",f.jsx("input",{className:"input",type:"number",value:t,onChange:y})]}),f.jsxs("div",{className:"buttons",children:[f.jsxs("span",{className:"amount",children:[t,"ml"]}),f.jsx("button",{className:"confirm",type:"submit",onClick:h,children:"Save"})]})]})]})})})},pu=()=>{const[n,r]=D.useState(!1);ge(Yo);const t=He(),e=[{id:1,volume:"200 ml",date:14.02},{id:2,volume:"200 ml",date:14.45},{id:3,volume:"150 ml",date:16.12},{id:4,volume:"50 ml",date:18.01},{id:5,volume:"300 ml",date:19.03},{id:6,volume:"100 ml",date:21.05},{id:7,volume:"5 ml",date:22.05}],a=i=>{r(!0)},s=()=>{r(!1)},o=i=>{console.dir(i.target.closest("LI").id),t($a(i.target.closest("LI").id))};return f.jsxs(f.Fragment,{children:[f.jsxs(lu,{children:[f.jsx("h3",{className:"title",children:"Today"}),f.jsx("ul",{className:"waterList",children:e.length>0?e.map(i=>f.jsxs("li",{className:"waterItem",id:i.id,children:[f.jsxs("div",{className:"volumeAdnDate",children:[f.jsx("svg",{className:"waterGlass",width:"26",height:"26",stroke:"#9ebbff",fill:"none",children:f.jsx("use",{href:qe+"#water-glass"})}),f.jsx("span",{className:"waterVolume",children:i.volume}),f.jsx("span",{className:"waterTime",children:i.date})]}),f.jsxs("div",{className:"editDelete",children:[f.jsx("svg",{onClick:a,width:"16",height:"13",stroke:"#9ebbff",fill:"none",children:f.jsx("use",{href:qe+"#pencil-square"})}),f.jsx("svg",{onClick:o,width:"16",height:"16",stroke:"#ef5050",fill:"none",children:f.jsx("use",{href:qe+"#trash"})})]})]},i.id)):f.jsx("p",{children:"You don't have records on this day"})}),f.jsx("h3",{className:"addWater",children:"+ Add water"})]}),n&&f.jsx(du,{isModalOpen:n,closeModal:s})]})};var Bn={},fu=Bt;Object.defineProperty(Bn,"__esModule",{value:!0});var _a=Bn.default=void 0,hu=fu(Ht()),mu=f;_a=Bn.default=(0,hu.default)((0,mu.jsx)("path",{d:"M6.23 20.23 8 22l10-10L8 2 6.23 3.77 14.46 12z"}),"ArrowForwardIos");var Qn={},gu=Bt;Object.defineProperty(Qn,"__esModule",{value:!0});var Sa=Qn.default=void 0,yu=gu(Ht()),wu=f;Sa=Qn.default=(0,yu.default)((0,wu.jsx)("path",{d:"M11.67 3.87 9.9 2.1 0 12l9.9 9.9 1.77-1.77L3.54 12z"}),"ArrowBackIos");const bu=P.div`
  display: flex;
  flex-direction: column;
  gap: 16px;
  width: 280px;
...
`;const ln={colors:{white:"#FFFFFF",black:"#2F2F2F",blue:"#407BFF",red:"#EF5050",orange:"#FF9D43",grey:"#ECF2FF",violet:"#9EBBFF",violet_light:"#D7E3FF"},animation:{duration:"0.3s",cubicBezier:"cubic-bezier(0.5, 0, 0.2, 1)"}},Wu=()=>{const[n,r]=D.useState(new Date),t=He(),e=D.useRef(null),a=ge(m=>m.getCurrentNorm),s=ge(Oo),o=ge(Fo);D.useEffect(()=>{const m=new Date(n.getFullYear(),n.getMonth(),2),h=new Date(n.getFullYear(),n.getMonth()+1,1),y=m.toISOString().split("T")[0],w=h.toISOString().split("T")[0],b={startDate:y,endDate:w};t(ja(b)),console.log(b)},[t,n,a]);const i=()=>{const m=new Date(n.getFullYear(),n.getMonth()+1,1);r(m)},c=()=>{const m=new Date(n.getFullYear(),n.getMonth()-1,1);r(m)},l=()=>{const m=new Date;return n.getMonth()===m.getMonth()&&n.getFullYear()===m.getFullYear()},d=()=>new Date(n.getFullYear(),n.getMonth()+1,0).getDate(),p=()=>{const m=d();return Array.from({length:m},(h,y)=>{var x;const w=y+1,b=s&&((x=s[y])==null?void 0:x.consumedWaterPercentage);return f.jsx(Nu,{dailyWaterGoal:e,day:w,consumedWaterPercentage:b},w)})};return f.jsxs(xu,{className:"calendar",ref:e,children:[f.jsxs(Du,{children:[f.jsx(ku,{children:"Month"}),o&&f.jsx($u,{height:"60",width:"60",radius:"9",color:ln.colors.blue,ariaLabel:"three-dots-loading",wrapperStyle:{height:"30px",width:"40px",display:"flex",alignItems:"center",justifyContent:"center"},wrapperClassName:"",visible:!0}),f.jsxs(Cu,{children:[f.jsx(Fr,{"aria-label":"Previous month",onClick:c,children:f.jsx(Sa,{sx:{color:ln.colors.blue}})}),f.jsx(_u,{children:`${new Intl.DateTimeFormat("en-US",{month:"long"}).format(n)}, ${n.getFullYear()}`}),f.jsx(Fr,{"aria-label":"Next month",onClick:i,disabled:l(),children:f.jsx(_a,{sx:{color:ln.colors.blue}})})]})]}),f.jsx(Pu,{children:p()})]})},Au=P.div`
