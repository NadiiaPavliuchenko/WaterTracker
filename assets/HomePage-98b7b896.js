var No=Object.defineProperty;var Eo=(n,r,t)=>r in n?No(n,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[r]=t;var M=(n,r,t)=>(Eo(n,typeof r!="symbol"?r+"":r,t),t);import{r as k,a as Fr,u as P,b as ve,c as He,j as p,e as Yo,f as jr,g as Ro,d as Io,s as qe,h as Ht,M as Bt,i as Lo,k as Qt,l as Kt,R as Wr,m as w,n as Z,o as $o,p as Fo,q as jo,t as Wo,v as Ao,w as Cn,x as Ho,W as Bo}from"./index-89742611.js";const Ge=Math.min,$e=Math.max,Tt=Math.round,bt=Math.floor,Te=n=>({x:n,y:n}),Qo={left:"right",right:"left",bottom:"top",top:"bottom"},Ko={start:"end",end:"start"};function zo(n,r,t){return $e(n,Ge(r,t))}function zt(n,r){return typeof n=="function"?n(r):n}function Ze(n){return n.split("-")[0]}function mt(n){return n.split("-")[1]}function Vo(n){return n==="x"?"y":"x"}function _n(n){return n==="y"?"height":"width"}function Sn(n){return["top","bottom"].includes(Ze(n))?"y":"x"}function Pn(n){return Vo(Sn(n))}function qo(n,r,t){t===void 0&&(t=!1);const e=mt(n),o=Pn(n),s=_n(o);let a=o==="x"?e===(t?"end":"start")?"right":"left":e==="start"?"bottom":"top";return r.reference[s]>r.floating[s]&&(a=Nt(a)),[a,Nt(a)]}function Uo(n){const r=Nt(n);return[pn(n),r,pn(r)]}function pn(n){return n.replace(/start|end/g,r=>Ko[r])}function Xo(n,r,t){const e=["left","right"],o=["right","left"],s=["top","bottom"],a=["bottom","top"];switch(n){case"top":case"bottom":return t?r?o:e:r?e:o;case"left":case"right":return r?s:a;default:return[]}}function Go(n,r,t,e){const o=mt(n);let s=Xo(Ze(n),t==="start",e);return o&&(s=s.map(a=>a+"-"+o),r&&(s=s.concat(s.map(pn)))),s}function Nt(n){return n.replace(/left|right|bottom|top/g,r=>Qo[r])}function Zo(n){return{top:0,right:0,bottom:0,left:0,...n}}function Ar(n){return typeof n!="number"?Zo(n):{top:n,right:n,bottom:n,left:n}}function Et(n){return{...n,top:n.y,left:n.x,right:n.x+n.width,bottom:n.y+n.height}}function Kn(n,r,t){let{reference:e,floating:o}=n;const s=Sn(r),a=Pn(r),i=_n(a),c=Ze(r),l=s==="y",d=e.x+e.width/2-o.width/2,f=e.y+e.height/2-o.height/2,m=e[i]/2-o[i]/2;let h;switch(c){case"top":h={x:d,y:e.y-o.height};break;case"bottom":h={x:d,y:e.y+e.height};break;case"right":h={x:e.x+e.width,y:f};break;case"left":h={x:e.x-o.width,y:f};break;default:h={x:e.x,y:e.y}}switch(mt(r)){case"start":h[a]-=m*(t&&l?-1:1);break;case"end":h[a]+=m*(t&&l?-1:1);break}return h}const Jo=async(n,r,t)=>{const{placement:e="bottom",strategy:o="absolute",middleware:s=[],platform:a}=t,i=s.filter(Boolean),c=await(a.isRTL==null?void 0:a.isRTL(r));let l=await a.getElementRects({reference:n,floating:r,strategy:o}),{x:d,y:f}=Kn(l,e,c),m=e,h={},g=0;for(let y=0;y<i.length;y++){const{name:x,fn:v}=i[y],{x:b,y:D,data:O,reset:_}=await v({x:d,y:f,initialPlacement:e,placement:m,strategy:o,middlewareData:h,rects:l,platform:a,elements:{reference:n,floating:r}});d=b??d,f=D??f,h={...h,[x]:{...h[x],...O}},_&&g<=50&&(g++,typeof _=="object"&&(_.placement&&(m=_.placement),_.rects&&(l=_.rects===!0?await a.getElementRects({reference:n,floating:r,strategy:o}):_.rects),{x:d,y:f}=Kn(l,m,c)),y=-1)}return{x:d,y:f,placement:m,strategy:o,middlewareData:h}};async function ea(n,r){var t;r===void 0&&(r={});const{x:e,y:o,platform:s,rects:a,elements:i,strategy:c}=n,{boundary:l="clippingAncestors",rootBoundary:d="viewport",elementContext:f="floating",altBoundary:m=!1,padding:h=0}=zt(r,n),g=Ar(h),x=i[m?f==="floating"?"reference":"floating":f],v=Et(await s.getClippingRect({element:(t=await(s.isElement==null?void 0:s.isElement(x)))==null||t?x:x.contextElement||await(s.getDocumentElement==null?void 0:s.getDocumentElement(i.floating)),boundary:l,rootBoundary:d,strategy:c})),b=f==="floating"?{...a.floating,x:e,y:o}:a.reference,D=await(s.getOffsetParent==null?void 0:s.getOffsetParent(i.floating)),O=await(s.isElement==null?void 0:s.isElement(D))?await(s.getScale==null?void 0:s.getScale(D))||{x:1,y:1}:{x:1,y:1},_=Et(s.convertOffsetParentRelativeRectToViewportRelativeRect?await s.convertOffsetParentRelativeRectToViewportRelativeRect({elements:i,rect:b,offsetParent:D,strategy:c}):b);return{top:(v.top-_.top+g.top)/O.y,bottom:(_.bottom-v.bottom+g.bottom)/O.y,left:(v.left-_.left+g.left)/O.x,right:(_.right-v.right+g.right)/O.x}}const ta=n=>({name:"arrow",options:n,async fn(r){const{x:t,y:e,placement:o,rects:s,platform:a,elements:i,middlewareData:c}=r,{element:l,padding:d=0}=zt(n,r)||{};if(l==null)return{};const f=Ar(d),m={x:t,y:e},h=Pn(o),g=_n(h),y=await a.getDimensions(l),x=h==="y",v=x?"top":"left",b=x?"bottom":"right",D=x?"clientHeight":"clientWidth",O=s.reference[g]+s.reference[h]-m[h]-s.floating[g],_=m[h]-s.reference[h],N=await(a.getOffsetParent==null?void 0:a.getOffsetParent(l));let C=N?N[D]:0;(!C||!await(a.isElement==null?void 0:a.isElement(N)))&&(C=i.floating[D]||s.floating[g]);const T=O/2-_/2,Y=C/2-y[g]/2-1,ne=Ge(f[v],Y),J=Ge(f[b],Y),A=ne,re=C-y[g]-J,V=C/2-y[g]/2+T,z=zo(A,V,re),oe=!c.arrow&&mt(o)!=null&&V!==z&&s.reference[g]/2-(V<A?ne:J)-y[g]/2<0,j=oe?V<A?V-A:V-re:0;return{[h]:m[h]+j,data:{[h]:z,centerOffset:V-z-j,...oe&&{alignmentOffset:j}},reset:oe}}}),na=function(n){return n===void 0&&(n={}),{name:"flip",options:n,async fn(r){var t,e;const{placement:o,middlewareData:s,rects:a,initialPlacement:i,platform:c,elements:l}=r,{mainAxis:d=!0,crossAxis:f=!0,fallbackPlacements:m,fallbackStrategy:h="bestFit",fallbackAxisSideDirection:g="none",flipAlignment:y=!0,...x}=zt(n,r);if((t=s.arrow)!=null&&t.alignmentOffset)return{};const v=Ze(o),b=Ze(i)===i,D=await(c.isRTL==null?void 0:c.isRTL(l.floating)),O=m||(b||!y?[Nt(i)]:Uo(i));!m&&g!=="none"&&O.push(...Go(i,y,g,D));const _=[i,...O],N=await ea(r,x),C=[];let T=((e=s.flip)==null?void 0:e.overflows)||[];if(d&&C.push(N[v]),f){const A=qo(o,a,D);C.push(N[A[0]],N[A[1]])}if(T=[...T,{placement:o,overflows:C}],!C.every(A=>A<=0)){var Y,ne;const A=(((Y=s.flip)==null?void 0:Y.index)||0)+1,re=_[A];if(re)return{data:{index:A,overflows:T},reset:{placement:re}};let V=(ne=T.filter(z=>z.overflows[0]<=0).sort((z,oe)=>z.overflows[1]-oe.overflows[1])[0])==null?void 0:ne.placement;if(!V)switch(h){case"bestFit":{var J;const z=(J=T.map(oe=>[oe.placement,oe.overflows.filter(j=>j>0).reduce((j,Qe)=>j+Qe,0)]).sort((oe,j)=>oe[1]-j[1])[0])==null?void 0:J[0];z&&(V=z);break}case"initialPlacement":V=i;break}if(o!==V)return{reset:{placement:V}}}return{}}}};async function ra(n,r){const{placement:t,platform:e,elements:o}=n,s=await(e.isRTL==null?void 0:e.isRTL(o.floating)),a=Ze(t),i=mt(t),c=Sn(t)==="y",l=["left","top"].includes(a)?-1:1,d=s&&c?-1:1,f=zt(r,n);let{mainAxis:m,crossAxis:h,alignmentAxis:g}=typeof f=="number"?{mainAxis:f,crossAxis:0,alignmentAxis:null}:{mainAxis:0,crossAxis:0,alignmentAxis:null,...f};return i&&typeof g=="number"&&(h=i==="end"?g*-1:g),c?{x:h*d,y:m*l}:{x:m*l,y:h*d}}const oa=function(n){return n===void 0&&(n=0),{name:"offset",options:n,async fn(r){var t,e;const{x:o,y:s,placement:a,middlewareData:i}=r,c=await ra(r,n);return a===((t=i.offset)==null?void 0:t.placement)&&(e=i.arrow)!=null&&e.alignmentOffset?{}:{x:o+c.x,y:s+c.y,data:{...c,placement:a}}}}};function Ne(n){return Hr(n)?(n.nodeName||"").toLowerCase():"#document"}function ie(n){var r;return(n==null||(r=n.ownerDocument)==null?void 0:r.defaultView)||window}function Me(n){var r;return(r=(Hr(n)?n.ownerDocument:n.document)||window.document)==null?void 0:r.documentElement}function Hr(n){return n instanceof Node||n instanceof ie(n).Node}function se(n){return n instanceof Element||n instanceof ie(n).Element}function be(n){return n instanceof HTMLElement||n instanceof ie(n).HTMLElement}function zn(n){return typeof ShadowRoot>"u"?!1:n instanceof ShadowRoot||n instanceof ie(n).ShadowRoot}function gt(n){const{overflow:r,overflowX:t,overflowY:e,display:o}=le(n);return/auto|scroll|overlay|hidden|clip/.test(r+e+t)&&!["inline","contents"].includes(o)}function aa(n){return["table","td","th"].includes(Ne(n))}function On(n){const r=Tn(),t=le(n);return t.transform!=="none"||t.perspective!=="none"||(t.containerType?t.containerType!=="normal":!1)||!r&&(t.backdropFilter?t.backdropFilter!=="none":!1)||!r&&(t.filter?t.filter!=="none":!1)||["transform","perspective","filter"].some(e=>(t.willChange||"").includes(e))||["paint","layout","strict","content"].some(e=>(t.contain||"").includes(e))}function sa(n){let r=Je(n);for(;be(r)&&!Vt(r);){if(On(r))return r;r=Je(r)}return null}function Tn(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}function Vt(n){return["html","body","#document"].includes(Ne(n))}function le(n){return ie(n).getComputedStyle(n)}function qt(n){return se(n)?{scrollLeft:n.scrollLeft,scrollTop:n.scrollTop}:{scrollLeft:n.pageXOffset,scrollTop:n.pageYOffset}}function Je(n){if(Ne(n)==="html")return n;const r=n.assignedSlot||n.parentNode||zn(n)&&n.host||Me(n);return zn(r)?r.host:r}function Br(n){const r=Je(n);return Vt(r)?n.ownerDocument?n.ownerDocument.body:n.body:be(r)&&gt(r)?r:Br(r)}function ut(n,r,t){var e;r===void 0&&(r=[]),t===void 0&&(t=!0);const o=Br(n),s=o===((e=n.ownerDocument)==null?void 0:e.body),a=ie(o);return s?r.concat(a,a.visualViewport||[],gt(o)?o:[],a.frameElement&&t?ut(a.frameElement):[]):r.concat(o,ut(o,[],t))}function Qr(n){const r=le(n);let t=parseFloat(r.width)||0,e=parseFloat(r.height)||0;const o=be(n),s=o?n.offsetWidth:t,a=o?n.offsetHeight:e,i=Tt(t)!==s||Tt(e)!==a;return i&&(t=s,e=a),{width:t,height:e,$:i}}function Nn(n){return se(n)?n:n.contextElement}function Ue(n){const r=Nn(n);if(!be(r))return Te(1);const t=r.getBoundingClientRect(),{width:e,height:o,$:s}=Qr(r);let a=(s?Tt(t.width):t.width)/e,i=(s?Tt(t.height):t.height)/o;return(!a||!Number.isFinite(a))&&(a=1),(!i||!Number.isFinite(i))&&(i=1),{x:a,y:i}}const ia=Te(0);function Kr(n){const r=ie(n);return!Tn()||!r.visualViewport?ia:{x:r.visualViewport.offsetLeft,y:r.visualViewport.offsetTop}}function ca(n,r,t){return r===void 0&&(r=!1),!t||r&&t!==ie(n)?!1:r}function je(n,r,t,e){r===void 0&&(r=!1),t===void 0&&(t=!1);const o=n.getBoundingClientRect(),s=Nn(n);let a=Te(1);r&&(e?se(e)&&(a=Ue(e)):a=Ue(n));const i=ca(s,t,e)?Kr(s):Te(0);let c=(o.left+i.x)/a.x,l=(o.top+i.y)/a.y,d=o.width/a.x,f=o.height/a.y;if(s){const m=ie(s),h=e&&se(e)?ie(e):e;let g=m,y=g.frameElement;for(;y&&e&&h!==g;){const x=Ue(y),v=y.getBoundingClientRect(),b=le(y),D=v.left+(y.clientLeft+parseFloat(b.paddingLeft))*x.x,O=v.top+(y.clientTop+parseFloat(b.paddingTop))*x.y;c*=x.x,l*=x.y,d*=x.x,f*=x.y,c+=D,l+=O,g=ie(y),y=g.frameElement}}return Et({width:d,height:f,x:c,y:l})}const la=[":popover-open",":modal"];function zr(n){return la.some(r=>{try{return n.matches(r)}catch{return!1}})}function ua(n){let{elements:r,rect:t,offsetParent:e,strategy:o}=n;const s=o==="fixed",a=Me(e),i=r?zr(r.floating):!1;if(e===a||i&&s)return t;let c={scrollLeft:0,scrollTop:0},l=Te(1);const d=Te(0),f=be(e);if((f||!f&&!s)&&((Ne(e)!=="body"||gt(a))&&(c=qt(e)),be(e))){const m=je(e);l=Ue(e),d.x=m.x+e.clientLeft,d.y=m.y+e.clientTop}return{width:t.width*l.x,height:t.height*l.y,x:t.x*l.x-c.scrollLeft*l.x+d.x,y:t.y*l.y-c.scrollTop*l.y+d.y}}function da(n){return Array.from(n.getClientRects())}function Vr(n){return je(Me(n)).left+qt(n).scrollLeft}function pa(n){const r=Me(n),t=qt(n),e=n.ownerDocument.body,o=$e(r.scrollWidth,r.clientWidth,e.scrollWidth,e.clientWidth),s=$e(r.scrollHeight,r.clientHeight,e.scrollHeight,e.clientHeight);let a=-t.scrollLeft+Vr(n);const i=-t.scrollTop;return le(e).direction==="rtl"&&(a+=$e(r.clientWidth,e.clientWidth)-o),{width:o,height:s,x:a,y:i}}function fa(n,r){const t=ie(n),e=Me(n),o=t.visualViewport;let s=e.clientWidth,a=e.clientHeight,i=0,c=0;if(o){s=o.width,a=o.height;const l=Tn();(!l||l&&r==="fixed")&&(i=o.offsetLeft,c=o.offsetTop)}return{width:s,height:a,x:i,y:c}}function ha(n,r){const t=je(n,!0,r==="fixed"),e=t.top+n.clientTop,o=t.left+n.clientLeft,s=be(n)?Ue(n):Te(1),a=n.clientWidth*s.x,i=n.clientHeight*s.y,c=o*s.x,l=e*s.y;return{width:a,height:i,x:c,y:l}}function Vn(n,r,t){let e;if(r==="viewport")e=fa(n,t);else if(r==="document")e=pa(Me(n));else if(se(r))e=ha(r,t);else{const o=Kr(n);e={...r,x:r.x-o.x,y:r.y-o.y}}return Et(e)}function qr(n,r){const t=Je(n);return t===r||!se(t)||Vt(t)?!1:le(t).position==="fixed"||qr(t,r)}function ma(n,r){const t=r.get(n);if(t)return t;let e=ut(n,[],!1).filter(i=>se(i)&&Ne(i)!=="body"),o=null;const s=le(n).position==="fixed";let a=s?Je(n):n;for(;se(a)&&!Vt(a);){const i=le(a),c=On(a);!c&&i.position==="fixed"&&(o=null),(s?!c&&!o:!c&&i.position==="static"&&!!o&&["absolute","fixed"].includes(o.position)||gt(a)&&!c&&qr(n,a))?e=e.filter(d=>d!==a):o=i,a=Je(a)}return r.set(n,e),e}function ga(n){let{element:r,boundary:t,rootBoundary:e,strategy:o}=n;const a=[...t==="clippingAncestors"?ma(r,this._c):[].concat(t),e],i=a[0],c=a.reduce((l,d)=>{const f=Vn(r,d,o);return l.top=$e(f.top,l.top),l.right=Ge(f.right,l.right),l.bottom=Ge(f.bottom,l.bottom),l.left=$e(f.left,l.left),l},Vn(r,i,o));return{width:c.right-c.left,height:c.bottom-c.top,x:c.left,y:c.top}}function wa(n){const{width:r,height:t}=Qr(n);return{width:r,height:t}}function ya(n,r,t){const e=be(r),o=Me(r),s=t==="fixed",a=je(n,!0,s,r);let i={scrollLeft:0,scrollTop:0};const c=Te(0);if(e||!e&&!s)if((Ne(r)!=="body"||gt(o))&&(i=qt(r)),e){const f=je(r,!0,s,r);c.x=f.x+r.clientLeft,c.y=f.y+r.clientTop}else o&&(c.x=Vr(o));const l=a.left+i.scrollLeft-c.x,d=a.top+i.scrollTop-c.y;return{x:l,y:d,width:a.width,height:a.height}}function qn(n,r){return!be(n)||le(n).position==="fixed"?null:r?r(n):n.offsetParent}function Ur(n,r){const t=ie(n);if(!be(n)||zr(n))return t;let e=qn(n,r);for(;e&&aa(e)&&le(e).position==="static";)e=qn(e,r);return e&&(Ne(e)==="html"||Ne(e)==="body"&&le(e).position==="static"&&!On(e))?t:e||sa(n)||t}const ba=async function(n){const r=this.getOffsetParent||Ur,t=this.getDimensions;return{reference:ya(n.reference,await r(n.floating),n.strategy),floating:{x:0,y:0,...await t(n.floating)}}};function xa(n){return le(n).direction==="rtl"}const Xr={convertOffsetParentRelativeRectToViewportRelativeRect:ua,getDocumentElement:Me,getClippingRect:ga,getOffsetParent:Ur,getElementRects:ba,getClientRects:da,getDimensions:wa,getScale:Ue,isElement:se,isRTL:xa};function va(n,r){let t=null,e;const o=Me(n);function s(){var i;clearTimeout(e),(i=t)==null||i.disconnect(),t=null}function a(i,c){i===void 0&&(i=!1),c===void 0&&(c=1),s();const{left:l,top:d,width:f,height:m}=n.getBoundingClientRect();if(i||r(),!f||!m)return;const h=bt(d),g=bt(o.clientWidth-(l+f)),y=bt(o.clientHeight-(d+m)),x=bt(l),b={rootMargin:-h+"px "+-g+"px "+-y+"px "+-x+"px",threshold:$e(0,Ge(1,c))||1};let D=!0;function O(_){const N=_[0].intersectionRatio;if(N!==c){if(!D)return a();N?a(!1,N):e=setTimeout(()=>{a(!1,1e-7)},100)}D=!1}try{t=new IntersectionObserver(O,{...b,root:o.ownerDocument})}catch{t=new IntersectionObserver(O,b)}t.observe(n)}return a(!0),s}function Da(n,r,t,e){e===void 0&&(e={});const{ancestorScroll:o=!0,ancestorResize:s=!0,elementResize:a=typeof ResizeObserver=="function",layoutShift:i=typeof IntersectionObserver=="function",animationFrame:c=!1}=e,l=Nn(n),d=o||s?[...l?ut(l):[],...ut(r)]:[];d.forEach(v=>{o&&v.addEventListener("scroll",t,{passive:!0}),s&&v.addEventListener("resize",t)});const f=l&&i?va(l,t):null;let m=-1,h=null;a&&(h=new ResizeObserver(v=>{let[b]=v;b&&b.target===l&&h&&(h.unobserve(r),cancelAnimationFrame(m),m=requestAnimationFrame(()=>{var D;(D=h)==null||D.observe(r)})),t()}),l&&!c&&h.observe(l),h.observe(r));let g,y=c?je(n):null;c&&x();function x(){const v=je(n);y&&(v.x!==y.x||v.y!==y.y||v.width!==y.width||v.height!==y.height)&&t(),y=v,g=requestAnimationFrame(x)}return t(),()=>{var v;d.forEach(b=>{o&&b.removeEventListener("scroll",t),s&&b.removeEventListener("resize",t)}),f==null||f(),(v=h)==null||v.disconnect(),h=null,c&&cancelAnimationFrame(g)}}const ka=na,Un=ta,Ma=(n,r,t)=>{const e=new Map,o={platform:Xr,...t},s={...o.platform,_c:e};return Jo(n,r,{...o,platform:s})},Ca=n=>{function r(t){return{}.hasOwnProperty.call(t,"current")}return{name:"arrow",options:n,fn(t){const{element:e,padding:o}=typeof n=="function"?n(t):n;return e&&r(e)?e.current!=null?Un({element:e.current,padding:o}).fn(t):{}:e?Un({element:e,padding:o}).fn(t):{}}}};var _t=typeof document<"u"?k.useLayoutEffect:k.useEffect;function Yt(n,r){if(n===r)return!0;if(typeof n!=typeof r)return!1;if(typeof n=="function"&&n.toString()===r.toString())return!0;let t,e,o;if(n&&r&&typeof n=="object"){if(Array.isArray(n)){if(t=n.length,t!==r.length)return!1;for(e=t;e--!==0;)if(!Yt(n[e],r[e]))return!1;return!0}if(o=Object.keys(n),t=o.length,t!==Object.keys(r).length)return!1;for(e=t;e--!==0;)if(!{}.hasOwnProperty.call(r,o[e]))return!1;for(e=t;e--!==0;){const s=o[e];if(!(s==="_owner"&&n.$$typeof)&&!Yt(n[s],r[s]))return!1}return!0}return n!==n&&r!==r}function Gr(n){return typeof window>"u"?1:(n.ownerDocument.defaultView||window).devicePixelRatio||1}function Xn(n,r){const t=Gr(n);return Math.round(r*t)/t}function Gn(n){const r=k.useRef(n);return _t(()=>{r.current=n}),r}function _a(n){n===void 0&&(n={});const{placement:r="bottom",strategy:t="absolute",middleware:e=[],platform:o,elements:{reference:s,floating:a}={},transform:i=!0,whileElementsMounted:c,open:l}=n,[d,f]=k.useState({x:0,y:0,strategy:t,placement:r,middlewareData:{},isPositioned:!1}),[m,h]=k.useState(e);Yt(m,e)||h(e);const[g,y]=k.useState(null),[x,v]=k.useState(null),b=k.useCallback(j=>{j!==N.current&&(N.current=j,y(j))},[]),D=k.useCallback(j=>{j!==C.current&&(C.current=j,v(j))},[]),O=s||g,_=a||x,N=k.useRef(null),C=k.useRef(null),T=k.useRef(d),Y=c!=null,ne=Gn(c),J=Gn(o),A=k.useCallback(()=>{if(!N.current||!C.current)return;const j={placement:r,strategy:t,middleware:m};J.current&&(j.platform=J.current),Ma(N.current,C.current,j).then(Qe=>{const Ke={...Qe,isPositioned:!0};re.current&&!Yt(T.current,Ke)&&(T.current=Ke,Fr.flushSync(()=>{f(Ke)}))})},[m,r,t,J]);_t(()=>{l===!1&&T.current.isPositioned&&(T.current.isPositioned=!1,f(j=>({...j,isPositioned:!1})))},[l]);const re=k.useRef(!1);_t(()=>(re.current=!0,()=>{re.current=!1}),[]),_t(()=>{if(O&&(N.current=O),_&&(C.current=_),O&&_){if(ne.current)return ne.current(O,_,A);A()}},[O,_,A,ne,Y]);const V=k.useMemo(()=>({reference:N,floating:C,setReference:b,setFloating:D}),[b,D]),z=k.useMemo(()=>({reference:O,floating:_}),[O,_]),oe=k.useMemo(()=>{const j={position:t,left:0,top:0};if(!z.floating)return j;const Qe=Xn(z.floating,d.x),Ke=Xn(z.floating,d.y);return i?{...j,transform:"translate("+Qe+"px, "+Ke+"px)",...Gr(z.floating)>=1.5&&{willChange:"transform"}}:{position:t,left:Qe,top:Ke}},[t,i,z.floating,d.x,d.y]);return k.useMemo(()=>({...d,update:A,refs:V,elements:z,floatingStyles:oe}),[d,A,V,z,oe])}const Sa=P.h3`
...
`,ct=P.p`
  ...
  line-height: 1.28571;
  color: ${({theme:n})=>n.color.red};
`,Ra=n=>n.water.month,Ia=n=>n.water.dayInfo,Zr=n=>{var r;return(r=n.water.dayInfo)==null?void 0:r.consumedWaterPercentage},La=n=>{var r;return(r=n.water.dayInfo)==null?void 0:r.dailyWaterGoal},$a=n=>n.water.dayDataLoading,Fa=({closeModal:n})=>{const t=(ve(La)/1e3).toFixed(1),[e,o]=k.useState(""),[s,a]=k.useState(!0),i=15,c=f=>{const{value:m}=f.target,h=/^(\d+([.,]\d{0,1})?)?$/;var g=m;m.match(/^[.,]/)?g="0"+m:g=m.replace(/^0+([^.])/,"$1"),a(g===""||parseFloat(g.replace(",","."))<=i),h.test(g)&&o(g)},l=He(),d=async f=>{if(f.preventDefault(),!s||e<=0)return;const m=f.target.elements.dailyNorm.value*1e3;try{const{payload:h}=await l(Yo(m));h.user&&(l(jr()),n())}catch(h){console.log("🚀 ~ error:",h)}};return p.jsxs("form",{onSubmit:d,children:[p.jsxs(Ea,{children:["Write down how much water you will drink:",p.jsx(fn,{className:!s&&e<=0?"error":"",type:"number",name:"dailyNorm",value:e,onChange:c,placeholder:t}),!s&&p.jsx(ct,{children:`The water rate cannot exceed ${i} liters`}),e<0&&p.jsx(ct,{children:"The water rate cannot be negative"}),parseFloat(e)===0&&p.jsx(ct,{children:"The water rate cannot be 0"})]}),p.jsx(Ya,{className:"confirm",type:"submit",children:"Save"})]})},ja=()=>{const n=ve(Ro),[r,t]=k.useState(n),[e,o]=k.useState(""),[s,a]=k.useState(""),[i,c]=k.useState(!0),[l,d]=k.useState(!0),f=ve(Io)?"dark":"light",h=`radio-${r==="woman"?"active":"inactive"}-${f}`,y=`radio-${r==="man"?"active":"inactive"}-${f}`,x=300,v=12,b=_=>{const{name:N,value:C}=_.target,T=/^(\d+([.,]\d{0,1})?)?$/;var Y=C;switch(N){case"gender":t(C);break;case"weight":C.match(/^[.,]/)?Y="0"+C:Y=C.replace(/^0+([^.])/,"$1"),c(Y===""||parseFloat(Y.replace(",","."))<=x),T.test(Y)&&o(Y);break;case"activeHours":C.match(/^[.,]/)?Y="0"+C:Y=C.replace(/^0+([^.])/,"$1"),d(Y===""||parseFloat(Y.replace(",","."))<=v),T.test(Y)&&a(Y);break}},D=r==="woman"?e*.03+s*.4:e*.04+s*.6,O=Math.round(D*10)/10;return p.jsx("div",{children:p.jsxs("form",{action:"",children:[p.jsx(Sa,{children:"Calculate your rate:"}),p.jsxs(Pa,{children:[p.jsxs(Zn,{children:[p.jsx(Jn,{id:"woman",type:"radio",name:"gender",value:"woman",checked:r==="woman",onChange:b}),p.jsxs(er,{htmlFor:"woman",children:[p.jsx(tr,{children:p.jsx(nr,{children:p.jsx("use",{href:`${qe}#${h}`})})}),"For woman"]})]}),p.jsxs(Zn,{children:[p.jsx(Jn,{id:"man",type:"radio",name:"gender",value:"man",checked:r==="man",onChange:b}),p.jsxs(er,{htmlFor:"man",children:[p.jsx(tr,{children:p.jsx(nr,{children:p.jsx("use",{href:`${qe}#${y}`})})}),"For man"]})]})]}),p.jsxs(rr,{children:["Your weight in kilograms:",p.jsx(fn,{className:i?"":"error",type:"number",name:"weight",value:e,onChange:b,placeholder:"0"}),!i&&p.jsx(ct,{children:`Weight cannot exceed ${x} kg`})]}),p.jsxs(rr,{children:["The time of active participation in sports or other activities with a high physical. load in hours:",p.jsx(fn,{className:l?"":"error",type:"number",name:"activeHours",value:s,onChange:b,placeholder:"0"}),!l&&p.jsx(ct,{children:`Active hours cannot exceed ${v} hours`})]}),p.jsxs(Oa,{children:[p.jsxs(Ta,{children:["The required amount of water in liters per day:"," "]}),i&&l&&p.jsxs(Na,{children:[O," L"]})]})]})})},Wa=P.div`
  display: flex;
  flex-direction: column;
  gap: 24px;
...
`,Va=P.span`
  color: ${({theme:n})=>n.color.blue};
`,qa=({isModalOpen:n,closeModal:r})=>p.jsx(p.Fragment,{children:n&&p.jsx(Bt,{onClose:r,children:p.jsxs(Wa,{children:[p.jsxs("div",{children:[p.jsxs(Aa,{className:"topline",children:[p.jsx(Ha,{children:"My daily norm"}),p.jsx(Ba,{className:"close",onClick:r})]}),p.jsxs(Qa,{children:[p.jsxs(or,{children:["For woman: ",p.jsx(ar,{children:"V=(M*0,03) + (T*0,4)"})]}),p.jsxs(or,{children:["For man: ",p.jsx(ar,{children:"V=(M*0,04) + (T*0,6)"})]})]}),p.jsx(Ka,{children:p.jsxs(za,{children:[p.jsx(Va,{children:"*"})," V is the volume of the water norm in liters per day, M is your body weight, T is the time of active sports, or another type of activity commensurate in terms of loads (in the absence of these, you must set 0)"]})})]}),p.jsx("div",{children:p.jsx(ja,{})}),p.jsx("div",{children:p.jsx(Fa,{closeModal:r})})]})})}),Ua=P.div`
  display: inline-flex;
  padding: 8px 20px;
  height: 74px;
  width: 150px;
...
`,ts="/WaterTrackerFrontend/assets/bottle_desk_1x-8726a8d2.png",ns=()=>{const{dailyWaterGoal:n}=ve(Lo),[r,t]=k.useState(!1),e=He(),o=()=>{t(!0)},s=()=>{t(!1)},a=(n/1e3).toFixed(1)+" L";return k.useEffect(()=>{e(jr())},[e]),p.jsxs(Ua,{children:[p.jsx(Xa,{children:"My daily norma: "}),p.jsxs(Ja,{children:[p.jsx(Za,{children:a}),p.jsx(Ga,{onClick:o,children:"Edit"})]}),p.jsx(qa,{isModalOpen:r,closeModal:s}),p.jsx(es,{src:ts,alt:"Bottle"})]})},rs=P.div`
  display: flex;
  height: 90px;
  flex-direction: column;
  align-items: flex-start;
...
`,Po=({isModalOpen:n,closeModal:r})=>{const[t,e]=k.useState(50),[o,s]=k.useState(new Date),a=He(),i=()=>{e(m=>m+50)},c=()=>{t>=50&&e(m=>m-50)},l=m=>{s(m)},d=m=>{m.preventDefault();const h=o.getTimezoneOffset();a(Fo({date:o,ml:t,timeZoneOffset:h})),r()},f=m=>{const h=parseInt(m.target.value);e(h)};return p.jsx(p.Fragment,{children:n&&p.jsx(Bt,{onClose:r,children:p.jsxs(cu,{children:[p.jsxs("div",{className:"topline",children:[p.jsx("h2",{children:"Add water"}),p.jsx(Ht,{className:"close",onClick:r})]}),p.jsx("p",{children:"Choose of water:"}),p.jsxs("form",{onSubmit:d,children:[p.jsxs("label",{children:["Amount of water:",p.jsxs("div",{className:"counter",children:[p.jsx("button",{className:"counterBtn",type:"button",onClick:i,children:p.jsx(Yn,{})}),p.jsxs("span",{className:"waterAmount",children:[t,"ml"]}),p.jsx("button",{className:"counterBtn",type:"button",onClick:c,children:p.jsx(In,{})})]})]}),p.jsxs("label",{children:["Recording time:",p.jsx(So,{className:"input",selected:o,onChange:m=>l(m),showTimeSelect:!0,showTimeSelectOnly:!0,timeFormat:"HH:mm",dateFormat:"HH:mm"})]}),p.jsxs("label",{children:["Enter the value of the water used:",p.jsx("input",{className:"input",type:"number",value:t,onChange:f})]}),p.jsxs("div",{className:"buttons",children:[p.jsxs("span",{className:"amount",children:[t,"ml"]}),p.jsx("button",{className:"confirm",type:"submit",onClick:d,children:"Save"})]})]})]})})})},lu=()=>{const[n,r]=k.useState(!1),t=ve(Zr),e=He(),o=()=>{r(!0)},s=()=>{r(!1)},a=t>100?100:t;return k.useEffect(()=>{e(jo())},[e]),p.jsx(p.Fragment,{children:p.jsxs(rs,{children:[p.jsx("h3",{children:"Today"}),p.jsxs("div",{className:"box",children:[p.jsx(os,{children:p.jsx("div",{className:"progress-bar-container",children:p.jsxs("div",{className:"progress-bar",children:[p.jsx("div",{className:"progress",style:{width:`${a}%`}}),p.jsx("div",{className:"line-0",children:"|"}),p.jsx("div",{className:"line-50",children:"|"}),p.jsx("div",{className:"line-100",children:"|"}),p.jsx("div",{className:"marker-0",children:"0%"}),p.jsx("div",{className:"marker-50",children:"50%"}),p.jsx("div",{className:"marker-100",children:"100%"}),p.jsx("div",{className:"indicator",style:{left:`${a}%`},children:p.jsx("p",{className:"progress-text",children:t>100?`${t}%`:`${a}%`})})]})})}),p.jsxs(as,{onClick:o,children:[p.jsx(ss,{width:"20px",height:"20px",children:p.jsx("use",{xlinkHref:`${qe}#plus-circle`})})," ",p.jsx("p",{children:"Add Water"})]})]}),n&&p.jsx(Po,{isModalOpen:n,closeModal:s})]})})},uu=P.div`
  *::-webkit-scrollbar {
    width: 4px;
  }
...
`,pu=n=>{console.log("🚀 ~ isoDateString:",n);const r=new Date(n),t=r.getTimezoneOffset();console.log("🚀 ~ timeZoneOffset:",t);const e=Math.floor(Math.abs(t)/60);console.log("🚀 ~ offsetHours:",e);const o=Math.abs(t)%60;console.log("🚀 ~ offsetMinutes:",o);const s=e.toString().padStart(2,"0");console.log("🚀 ~ offsetHoursFormatted:",s);const a=o.toString().padStart(2,"0");console.log("🚀 ~ offsetMinutesFormatted:",a);const i=`${t>=0?"-":"+"}${s}:${a}`;console.log("🚀 ~ timeZoneOffsetString:",i);const c=new Date(r.getFullYear(),r.getMonth(),r.getDate(),r.getHours(),r.getMinutes(),r.getSeconds());console.log("🚀 ~ dateWithoutMilliseconds:",c);const l=`${c.toISOString().split(".")[0]}${i}`;return console.log("🚀 ~ isoDateWithTimeZone:",l),l},fu=({isModalOpen:n,closeModal:r,currentIntakes:t})=>{const[e,o]=k.useState(t.ml);console.log("🚀 ~ waterAmount:",e);const s=pu(t.time),[a,i]=k.useState(new Date(s));console.log("🚀 ~ selectedTime:",a);const c=He(),l=()=>{o(g=>g+50)},d=()=>{e>=50&&o(g=>g-50)},f=g=>{i(g)},m=g=>{g.preventDefault();const y=new Date(a).getTimezoneOffset(),x={date:a,ml:e,timeZoneOffset:y};c(Wo({id:t.id,body:x}))},h=g=>{const y=parseInt(g.target.value);o(y)};return p.jsx(p.Fragment,{children:n&&p.jsx(Bt,{onClose:r,children:p.jsxs(du,{children:[p.jsxs("div",{className:"topline",children:[p.jsx("h2",{children:"Edit the entered amount of water"}),p.jsx(Ht,{className:"close",onClick:r})]}),p.jsxs("p",{children:[p.jsxs("span",{className:"amount",children:[t.ml,"ml"]}),t.time.slice(11,16)]}),p.jsx("p",{children:"Correct entered data:"}),p.jsxs("form",{onSubmit:m,children:[p.jsxs("label",{children:["Amount of water:",p.jsxs("div",{className:"counter",children:[p.jsx("button",{className:"counterBtn",type:"button",onClick:l,children:p.jsx(Yn,{})}),p.jsxs("span",{className:"waterAmount",children:[e,"ml"]}),p.jsx("button",{className:"counterBtn",type:"button",onClick:d,children:p.jsx(In,{})})]})]}),p.jsxs("label",{children:["Recording time:",p.jsx(So,{className:"input",selected:a,onChange:g=>f(g),showTimeSelect:!0,showTimeSelectOnly:!0,timeFormat:"HH:mm",dateFormat:"HH:mm"})]}),p.jsxs("label",{children:["Enter the value of the water used:",p.jsx("input",{className:"input",type:"number",value:e,onChange:h})]}),p.jsxs("div",{className:"buttons",children:[p.jsxs("span",{className:"amount",children:[e,"ml"]}),p.jsx("button",{className:"confirm",type:"submit",onClick:m,children:"Save"})]})]})]})})})},hu=P.div`
  display: block;
  position: absolute;
  top: 50%;
  left: 50%;
...
`,gu=({onModalClose:n,isModalOpen:r,currentIntakes:t})=>{const e=He(),o=()=>{const s=new Date(t.time).getTimezoneOffset(),a={id:t.id,body:{date:t.time,timeZoneOffset:s}};e(Ao(a))};return p.jsx(p.Fragment,{children:r&&p.jsx(Bt,{onClose:n,children:p.jsxs(hu,{children:[p.jsxs("div",{children:[p.jsxs("div",{className:"topline",children:[p.jsx("h2",{children:"Delete water intakes"}),p.jsx(Ht,{className:"close",onClick:n})]}),p.jsx("p",{children:"Do you really want delete that water intakes?"})]}),p.jsxs(mu,{children:[p.jsx("button",{className:"confirm",onClick:o,children:"Delete"}),p.jsx("button",{className:"cancel",onClick:n,children:"Cancel"})]})]})})})},wu=()=>{const[n,r]=k.useState(!1),[t,e]=k.useState(!1),[o,s]=k.useState(!1),[a,i]=k.useState({}),c=ve(Ia);console.log(c);const l=y=>{const x={id:y.target.closest("LI").id,ml:Number(y.target.closest("LI").childNodes[0].childNodes[1].textContent),time:y.target.closest("LI").attributes.time.value};i(x),r(!0)},d=()=>{r(!1)},f=()=>{e(!0)},m=()=>{e(!1)},h=y=>{const x={id:y.target.closest("LI").id,time:y.target.closest("LI").attributes.time.value};i(x),s(!0)},g=()=>{s(!1)};return console.log("dayInfoTrunks.waterIntakes :>> ",c.waterIntakes),p.jsxs(p.Fragment,{children:[p.jsxs(uu,{children:[p.jsx("h3",{className:"title",children:"Today"}),p.jsx("ul",{className:"waterList",children:c.waterIntakes.length>0?c.waterIntakes.map(y=>p.jsxs("li",{className:"waterItem",id:y._id,time:y.consumedAt,children:[p.jsxs("div",{className:"volumeAdnDate",children:[p.jsx("svg",{className:"waterGlass",width:"26",height:"26",stroke:"#9ebbff",fill:"none",children:p.jsx("use",{href:qe+"#water-glass"})}),p.jsxs("span",{className:"waterVolume",children:[y.ml," "]}),p.jsx("span",{className:"waterVolumeMl",children:"ml"}),p.jsx("span",{className:"waterTime",children:y.consumedAt.slice(11,16)})]}),p.jsxs("div",{className:"editDelete",children:[p.jsx("svg",{onClick:l,width:"16",height:"13",stroke:"#9ebbff",fill:"none",children:p.jsx("use",{href:qe+"#pencil-square"})}),p.jsx("svg",{onClick:h,width:"16",height:"16",stroke:"#ef5050",fill:"none",children:p.jsx("use",{href:qe+"#trash"})})]})]},y._id)):p.jsx("p",{children:"Today you don't have records"})}),p.jsx("h2",{className:"addWater",onClick:f,children:"+ Add water"})]}),n&&p.jsx(fu,{isModalOpen:n,closeModal:d,currentIntakes:a}),t&&p.jsx(Po,{isModalOpen:t,closeModal:m}),o&&p.jsx(gu,{isModalOpen:o,onModalClose:g,currentIntakes:a})]})};var Bn={},yu=Kt;Object.defineProperty(Bn,"__esModule",{value:!0});var Oo=Bn.default=void 0,bu=yu(Qt()),xu=p;Oo=Bn.default=(0,bu.default)((0,xu.jsx)("path",{d:"M6.23 20.23 8 22l10-10L8 2 6.23 3.77 14.46 12z"}),"ArrowForwardIos");var Qn={},vu=Kt;Object.defineProperty(Qn,"__esModule",{value:!0});var To=Qn.default=void 0,Du=vu(Qt()),ku=p;To=Qn.default=(0,Du.default)((0,ku.jsx)("path",{d:"M11.67 3.87 9.9 2.1 0 12l9.9 9.9 1.77-1.77L3.54 12z"}),"ArrowBackIos");const Mu=P.div`
  display: flex;
  flex-direction: column;
  gap: 16px;
  width: 280px;
...
`;const dn={colors:{white:"#FFFFFF",black:"#2F2F2F",blue:"#407BFF",red:"#EF5050",orange:"#FF9D43",grey:"#ECF2FF",violet:"#9EBBFF",violet_light:"#D7E3FF"},animation:{duration:"0.3s",cubicBezier:"cubic-bezier(0.5, 0, 0.2, 1)"}},Ku=()=>{const[n,r]=k.useState(new Date),t=He(),e=k.useRef(null),o=ve(Zr),s=ve(Ra),a=ve($a);k.useEffect(()=>{const g=n.getTimezoneOffset(),y=new Date(n.getFullYear(),n.getMonth(),1);y.setMinutes(y.getMinutes()-g);const x=new Date(n.getFullYear(),n.getMonth()+1,0);x.setMinutes(x.getMinutes()-g);const v=y.toISOString().split("T")[0],b=x.toISOString().split("T")[0],D={startDate:v,endDate:b};t(Ho(D)),console.log(D)},[t,n,o]);const i=()=>{const g=new Date(n.getFullYear(),n.getMonth()+1,1);r(g)},c=()=>{const g=new Date(n.getFullYear(),n.getMonth()-1,1);r(g)},l=()=>{const g=new Date;return n.getMonth()===g.getMonth()&&n.getFullYear()===g.getFullYear()},d=()=>new Date(n.getFullYear(),n.getMonth()+1,0).getDate(),f=()=>{const g=new Date(n).getMonth(),y=new Date(n).toLocaleString("en-US",{month:"long"});return{monthNumber:g,monthName:y}},m=()=>new Date(n).getFullYear(),h=()=>{const g=d(),y=f(),x=m();return Array.from({length:g},(v,b)=>{if(!s)return;const D=b+1,O=s.find(({entryDate:T})=>D===new Date(T).getDate()),_=O?O.consumedWaterPercentage:0,N=O?O.dailyWaterGoal:0,C=O?O.consumedTimes:0;return p.jsx(Iu,{day:D,month:y,year:x,dailyWaterGoal:N,consumedWaterPercentage:_,consumedTimes:C},D)})};return p.jsxs(_u,{className:"calendar",ref:e,children:[p.jsxs(Su,{children:[p.jsx(Pu,{children:"Month"}),a&&p.jsx(Bu,{height:"60",width:"60",radius:"9",color:dn.colors.blue,ariaLabel:"three-dots-loading",wrapperStyle:{height:"30px",width:"40px",display:"flex",alignItems:"center",justifyContent:"center"},wrapperClassName:"",visible:!0}),p.jsxs(Tu,{children:[p.jsx($r,{"aria-label":"Previous month",onClick:c,children:p.jsx(To,{sx:{color:dn.colors.blue}})}),p.jsx(Nu,{children:`${new Intl.DateTimeFormat("en-US",{month:"long"}).format(n)}, ${n.getFullYear()}`}),p.jsx($r,{"aria-label":"Next month",onClick:i,disabled:l(),children:p.jsx(Oo,{sx:{color:dn.colors.blue}})})]})]}),p.jsx(Yu,{children:h()})]})},zu=P.div`
...
`,Ju=()=>p.jsx(zu,{children:p.jsx(Bo,{children:p.jsxs(Vu,{children:[p.jsxs(qu,{children:[p.jsx(ns,{}),p.jsx(lu,{})]}),p.jsx(Uu,{children:p.jsxs(Xu,{children:[p.jsx(wu,{}),p.jsx(Ku,{})]})})]})})});export{Ju as default};
