import{u as x,B as b,C as d,J as g,j as t,F as u,D as w,E as c,s as i,G as p,Q as f,r as j,c as v,W as y,L as h,O as k,U as $}from"./index-66818bd2.js";import{b as m,a as S}from"./bottle_mob_2x-8d352aa4.js";import{b as N,a as P,c as I,d as F}from"./bottle_desk_2x-b7d1eae2.js";const R=x.div`
...
`,_=({submitFunc:e})=>{const r=b({password:d().min(6).max(64).required(),repeatPassword:d().oneOf([g("password"),null],"Passwords must match")}),n={password:"",repeatPassword:""};function l(o,s){e(o.password),s.resetForm()}function a(o){const s=o.target.closest(".watchPasswordIcon").previousSibling;if(s.type==="password"){s.type="text",o.target.closest("SVG").firstChild.href.baseVal=i+"#eye-opened";return}if(s.type==="text"){s.type="password",o.target.closest("SVG").firstChild.href.baseVal=i+"#eye-closed";return}}return t.jsx(t.Fragment,{children:t.jsx(R,{children:t.jsx(u,{initialValues:n,validationSchema:r,onSubmit:l,children:t.jsxs(w,{className:"form",autoComplete:"off",children:[t.jsxs("label",{className:"label",htmlFor:"password",children:["Enter your password",t.jsxs("div",{className:"input-container",children:[t.jsx(c,{className:"input",type:"password",name:"password",placeholder:"Password"}),t.jsx("svg",{className:"watchPasswordIcon",onClick:a,width:"16",height:"14",stroke:"#9ebbff",fill:"none",children:t.jsx("use",{href:i+"#eye-closed"})})]}),t.jsx(p,{className:"error",name:"password",component:"div"})]}),t.jsx("br",{}),t.jsxs("label",{className:"label",htmlFor:"repeatPassword",children:["Repeat password",t.jsxs("div",{className:"input-container",children:[t.jsx(c,{className:"input",type:"password",name:"repeatPassword",placeholder:"Repeat password"}),t.jsx("svg",{className:"watchPasswordIcon",onClick:a,width:"16",height:"14",stroke:"#9ebbff",fill:"none",children:t.jsx("use",{href:i+"#eye-closed"})})]}),t.jsx(p,{className:"error",name:"repeatPassword",component:"div"})]}),t.jsx("br",{}),t.jsx("button",{className:"buttonSignUp",type:"submit",children:"Save"})]})})})})},U=x.div`
  background-size: 100%;
