...
`,qo=P.span`
  color: ${({theme:n})=>n.color.blue};
`,Uo=({isModalOpen:n,closeModal:r})=>f.jsx(f.Fragment,{children:n&&f.jsx(Mn,{onClose:r,children:f.jsxs(Ao,{children:[f.jsxs("div",{children:[f.jsxs(Ho,{className:"topline",children:[f.jsx(Bo,{children:"My daily norm"}),f.jsx(Qo,{className:"close",onClick:r})]}),f.jsxs(Ko,{children:[f.jsxs(ar,{children:["For woman: ",f.jsx(or,{children:"V=(M*0,03) + (T*0,4)"})]}),f.jsxs(ar,{children:["For man: ",f.jsx(or,{children:"V=(M*0,04) + (T*0,6)"})]})]}),f.jsx(zo,{children:f.jsxs(Vo,{children:[f.jsx(qo,{children:"*"})," V is the volume of the water norm in liters per day, M is your body weight, T is the time of active sports, or another type of activity commensurate in terms of loads (in the absence of these, you must set 0)"]})})]}),f.jsx("div",{children:f.jsx(Wo,{})}),f.jsx("div",{children:f.jsx(jo,{closeModal:r})})]})})}),Xo=P.div`
  display: inline-flex;
  padding: 8px 20px;
  height: 74px;
  width: 150px;
...
`,cu=({isModalOpen:n,closeModal:r})=>{const[t,e]=D.useState(50),[a,s]=D.useState(new Date),o=He(),i=()=>{e(m=>m+50)},c=()=>{t>=50&&e(m=>m-50)},l=m=>{s(m)},d=m=>{m.preventDefault();const h=a.getTimezoneOffset();o(Ia({date:a,ml:t,timeZoneOffset:h}))},p=m=>{const h=parseInt(m.target.value);e(h)};return f.jsx(f.Fragment,{children:n&&f.jsx(Mn,{onClose:r,children:f.jsxs(iu,{children:[f.jsxs("div",{className:"topline",children:[f.jsx("h2",{children:"Add water"}),f.jsx(kn,{className:"close",onClick:r})]}),f.jsx("p",{children:"Choose of water:"}),f.jsxs("form",{onSubmit:d,children:[f.jsxs("label",{children:["Amount of water:",f.jsxs("div",{className:"counter",children:[f.jsx("button",{className:"counterBtn",type:"button",onClick:i,children:f.jsx(Yn,{})}),f.jsxs("span",{className:"waterAmount",children:[t,"ml"]}),f.jsx("button",{className:"counterBtn",type:"button",onClick:c,children:f.jsx(In,{})})]})]}),f.jsxs("label",{children:["Recording time:",f.jsx(Ca,{className:"input",selected:a,onChange:m=>l(m),showTimeSelect:!0,showTimeSelectOnly:!0,timeFormat:"HH:mm",dateFormat:"HH:mm"})]}),f.jsxs("label",{children:["Enter the value of the water used:",f.jsx("input",{className:"input",type:"number",value:t,onChange:p})]}),f.jsxs("div",{className:"buttons",children:[f.jsxs("span",{className:"amount",children:[t,"ml"]}),f.jsx("button",{className:"confirm",type:"submit",onClick:d,children:"Save"})]})]})]})})})},lu=()=>{const[n,r]=D.useState(!1),t=ge(Lo),e=He(),a=()=>{r(!0)},s=()=>{r(!1)},o=t>100?100:t;return D.useEffect(()=>{e(La())},[e]),f.jsx(f.Fragment,{children:f.jsxs(ns,{children:[f.jsx("h3",{children:"Today"}),f.jsxs("div",{className:"box",children:[f.jsx(rs,{children:f.jsx("div",{className:"progress-bar-container",children:f.jsxs("div",{className:"progress-bar",children:[f.jsx("div",{className:"progress",style:{width:`${o}%`}}),f.jsx("div",{className:"line-0",children:"|"}),f.jsx("div",{className:"line-50",children:"|"}),f.jsx("div",{className:"line-100",children:"|"}),f.jsx("div",{className:"marker-0",children:"0%"}),f.jsx("div",{className:"marker-50",children:"50%"}),f.jsx("div",{className:"marker-100",children:"100%"}),f.jsx("div",{className:"indicator",style:{left:`${o}%`},children:f.jsx("p",{className:"progress-text",children:t>100?`${t}%`:`${o}%`})})]})})}),f.jsxs(as,{onClick:a,children:[f.jsx(os,{width:"20px",height:"20px",children:f.jsx("use",{xlinkHref:`${qe}#plus-circle`})})," ",f.jsx("p",{children:"Add Water"})]})]}),n&&f.jsx(cu,{isModalOpen:n,closeModal:s})]})})},uu=P.div`
