var Pa=Object.defineProperty;var Ea=(n,r,t)=>r in n?Pa(n,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[r]=t;var k=(n,r,t)=>(Ea(n,typeof r!="symbol"?r+"":r,t),t);import{r as D,a as Fr,u as P,b as ge,c as He,j as f,e as Na,f as jr,g as Ta,d as Oa,s as qe,h as kn,M as Mn,i as Ya,k as Ht,l as Bt,R as Wr,m as g,n as Z,o as Ra,p as Ia,q as La,t as $a,v as Fa,w as Cn,x as ja,W as Wa}from"./index-dd2ae7c8.js";const Ge=Math.min,$e=Math.max,Nt=Math.round,bt=Math.floor,Ne=n=>({x:n,y:n}),Aa={left:"right",right:"left",bottom:"top",top:"bottom"},Ha={start:"end",end:"start"};function Ba(n,r,t){return $e(n,Ge(r,t))}function Qt(n,r){return typeof n=="function"?n(r):n}function Ze(n){return n.split("-")[0]}function mt(n){return n.split("-")[1]}function Qa(n){return n==="x"?"y":"x"}function _n(n){return n==="y"?"height":"width"}function Sn(n){return["top","bottom"].includes(Ze(n))?"y":"x"}function Pn(n){return Qa(Sn(n))}function Ka(n,r,t){t===void 0&&(t=!1);const e=mt(n),a=Pn(n),s=_n(a);let o=a==="x"?e===(t?"end":"start")?"right":"left":e==="start"?"bottom":"top";return r.reference[s]>r.floating[s]&&(o=Tt(o)),[o,Tt(o)]}function za(n){const r=Tt(n);return[un(n),r,un(r)]}function un(n){return n.replace(/start|end/g,r=>Ha[r])}function Va(n,r,t){const e=["left","right"],a=["right","left"],s=["top","bottom"],o=["bottom","top"];switch(n){case"top":case"bottom":return t?r?a:e:r?e:a;case"left":case"right":return r?s:o;default:return[]}}function qa(n,r,t,e){const a=mt(n);let s=Va(Ze(n),t==="start",e);return a&&(s=s.map(o=>o+"-"+a),r&&(s=s.concat(s.map(un)))),s}function Tt(n){return n.replace(/left|right|bottom|top/g,r=>Aa[r])}function Ua(n){return{top:0,right:0,bottom:0,left:0,...n}}function Ar(n){return typeof n!="number"?Ua(n):{top:n,right:n,bottom:n,left:n}}function Ot(n){return{...n,top:n.y,left:n.x,right:n.x+n.width,bottom:n.y+n.height}}function Kn(n,r,t){let{reference:e,floating:a}=n;const s=Sn(r),o=Pn(r),i=_n(o),c=Ze(r),l=s==="y",d=e.x+e.width/2-a.width/2,p=e.y+e.height/2-a.height/2,m=e[i]/2-a[i]/2;let h;switch(c){case"top":h={x:d,y:e.y-a.height};break;case"bottom":h={x:d,y:e.y+e.height};break;case"right":h={x:e.x+e.width,y:p};break;case"left":h={x:e.x-a.width,y:p};break;default:h={x:e.x,y:e.y}}switch(mt(r)){case"start":h[o]-=m*(t&&l?-1:1);break;case"end":h[o]+=m*(t&&l?-1:1);break}return h}const Xa=async(n,r,t)=>{const{placement:e="bottom",strategy:a="absolute",middleware:s=[],platform:o}=t,i=s.filter(Boolean),c=await(o.isRTL==null?void 0:o.isRTL(r));let l=await o.getElementRects({reference:n,floating:r,strategy:a}),{x:d,y:p}=Kn(l,e,c),m=e,h={},y=0;for(let w=0;w<i.length;w++){const{name:b,fn:x}=i[w],{x:v,y:M,data:N,reset:S}=await x({x:d,y:p,initialPlacement:e,placement:m,strategy:a,middlewareData:h,rects:l,platform:o,elements:{reference:n,floating:r}});d=v??d,p=M??p,h={...h,[b]:{...h[b],...N}},S&&y<=50&&(y++,typeof S=="object"&&(S.placement&&(m=S.placement),S.rects&&(l=S.rects===!0?await o.getElementRects({reference:n,floating:r,strategy:a}):S.rects),{x:d,y:p}=Kn(l,m,c)),w=-1)}return{x:d,y:p,placement:m,strategy:a,middlewareData:h}};async function Ga(n,r){var t;r===void 0&&(r={});const{x:e,y:a,platform:s,rects:o,elements:i,strategy:c}=n,{boundary:l="clippingAncestors",rootBoundary:d="viewport",elementContext:p="floating",altBoundary:m=!1,padding:h=0}=Qt(r,n),y=Ar(h),b=i[m?p==="floating"?"reference":"floating":p],x=Ot(await s.getClippingRect({element:(t=await(s.isElement==null?void 0:s.isElement(b)))==null||t?b:b.contextElement||await(s.getDocumentElement==null?void 0:s.getDocumentElement(i.floating)),boundary:l,rootBoundary:d,strategy:c})),v=p==="floating"?{...o.floating,x:e,y:a}:o.reference,M=await(s.getOffsetParent==null?void 0:s.getOffsetParent(i.floating)),N=await(s.isElement==null?void 0:s.isElement(M))?await(s.getScale==null?void 0:s.getScale(M))||{x:1,y:1}:{x:1,y:1},S=Ot(s.convertOffsetParentRelativeRectToViewportRelativeRect?await s.convertOffsetParentRelativeRectToViewportRelativeRect({elements:i,rect:v,offsetParent:M,strategy:c}):v);return{top:(x.top-S.top+y.top)/N.y,bottom:(S.bottom-x.bottom+y.bottom)/N.y,left:(x.left-S.left+y.left)/N.x,right:(S.right-x.right+y.right)/N.x}}const Za=n=>({name:"arrow",options:n,async fn(r){const{x:t,y:e,placement:a,rects:s,platform:o,elements:i,middlewareData:c}=r,{element:l,padding:d=0}=Qt(n,r)||{};if(l==null)return{};const p=Ar(d),m={x:t,y:e},h=Pn(a),y=_n(h),w=await o.getDimensions(l),b=h==="y",x=b?"top":"left",v=b?"bottom":"right",M=b?"clientHeight":"clientWidth",N=s.reference[y]+s.reference[h]-m[h]-s.floating[y],S=m[h]-s.reference[h],T=await(o.getOffsetParent==null?void 0:o.getOffsetParent(l));let _=T?T[M]:0;(!_||!await(o.isElement==null?void 0:o.isElement(T)))&&(_=i.floating[M]||s.floating[y]);const E=N/2-S/2,Y=_/2-w[y]/2-1,ne=Ge(p[x],Y),J=Ge(p[v],Y),A=ne,re=_-w[y]-J,V=_/2-w[y]/2+E,z=Ba(A,V,re),ae=!c.arrow&&mt(a)!=null&&V!==z&&s.reference[y]/2-(V<A?ne:J)-w[y]/2<0,j=ae?V<A?V-A:V-re:0;return{[h]:m[h]+j,data:{[h]:z,centerOffset:V-z-j,...ae&&{alignmentOffset:j}},reset:ae}}}),Ja=function(n){return n===void 0&&(n={}),{name:"flip",options:n,async fn(r){var t,e;const{placement:a,middlewareData:s,rects:o,initialPlacement:i,platform:c,elements:l}=r,{mainAxis:d=!0,crossAxis:p=!0,fallbackPlacements:m,fallbackStrategy:h="bestFit",fallbackAxisSideDirection:y="none",flipAlignment:w=!0,...b}=Qt(n,r);if((t=s.arrow)!=null&&t.alignmentOffset)return{};const x=Ze(a),v=Ze(i)===i,M=await(c.isRTL==null?void 0:c.isRTL(l.floating)),N=m||(v||!w?[Tt(i)]:za(i));!m&&y!=="none"&&N.push(...qa(i,w,y,M));const S=[i,...N],T=await Ga(r,b),_=[];let E=((e=s.flip)==null?void 0:e.overflows)||[];if(d&&_.push(T[x]),p){const A=Ka(a,o,M);_.push(T[A[0]],T[A[1]])}if(E=[...E,{placement:a,overflows:_}],!_.every(A=>A<=0)){var Y,ne;const A=(((Y=s.flip)==null?void 0:Y.index)||0)+1,re=S[A];if(re)return{data:{index:A,overflows:E},reset:{placement:re}};let V=(ne=E.filter(z=>z.overflows[0]<=0).sort((z,ae)=>z.overflows[1]-ae.overflows[1])[0])==null?void 0:ne.placement;if(!V)switch(h){case"bestFit":{var J;const z=(J=E.map(ae=>[ae.placement,ae.overflows.filter(j=>j>0).reduce((j,Qe)=>j+Qe,0)]).sort((ae,j)=>ae[1]-j[1])[0])==null?void 0:J[0];z&&(V=z);break}case"initialPlacement":V=i;break}if(a!==V)return{reset:{placement:V}}}return{}}}};async function eo(n,r){const{placement:t,platform:e,elements:a}=n,s=await(e.isRTL==null?void 0:e.isRTL(a.floating)),o=Ze(t),i=mt(t),c=Sn(t)==="y",l=["left","top"].includes(o)?-1:1,d=s&&c?-1:1,p=Qt(r,n);let{mainAxis:m,crossAxis:h,alignmentAxis:y}=typeof p=="number"?{mainAxis:p,crossAxis:0,alignmentAxis:null}:{mainAxis:0,crossAxis:0,alignmentAxis:null,...p};return i&&typeof y=="number"&&(h=i==="end"?y*-1:y),c?{x:h*d,y:m*l}:{x:m*l,y:h*d}}const to=function(n){return n===void 0&&(n=0),{name:"offset",options:n,async fn(r){var t,e;const{x:a,y:s,placement:o,middlewareData:i}=r,c=await eo(r,n);return o===((t=i.offset)==null?void 0:t.placement)&&(e=i.arrow)!=null&&e.alignmentOffset?{}:{x:a+c.x,y:s+c.y,data:{...c,placement:o}}}}};function Te(n){return Hr(n)?(n.nodeName||"").toLowerCase():"#document"}function ie(n){var r;return(n==null||(r=n.ownerDocument)==null?void 0:r.defaultView)||window}function Me(n){var r;return(r=(Hr(n)?n.ownerDocument:n.document)||window.document)==null?void 0:r.documentElement}function Hr(n){return n instanceof Node||n instanceof ie(n).Node}function se(n){return n instanceof Element||n instanceof ie(n).Element}function ve(n){return n instanceof HTMLElement||n instanceof ie(n).HTMLElement}function zn(n){return typeof ShadowRoot>"u"?!1:n instanceof ShadowRoot||n instanceof ie(n).ShadowRoot}function gt(n){const{overflow:r,overflowX:t,overflowY:e,display:a}=le(n);return/auto|scroll|overlay|hidden|clip/.test(r+e+t)&&!["inline","contents"].includes(a)}function no(n){return["table","td","th"].includes(Te(n))}function En(n){const r=Nn(),t=le(n);return t.transform!=="none"||t.perspective!=="none"||(t.containerType?t.containerType!=="normal":!1)||!r&&(t.backdropFilter?t.backdropFilter!=="none":!1)||!r&&(t.filter?t.filter!=="none":!1)||["transform","perspective","filter"].some(e=>(t.willChange||"").includes(e))||["paint","layout","strict","content"].some(e=>(t.contain||"").includes(e))}function ro(n){let r=Je(n);for(;ve(r)&&!Kt(r);){if(En(r))return r;r=Je(r)}return null}function Nn(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}function Kt(n){return["html","body","#document"].includes(Te(n))}function le(n){return ie(n).getComputedStyle(n)}function zt(n){return se(n)?{scrollLeft:n.scrollLeft,scrollTop:n.scrollTop}:{scrollLeft:n.pageXOffset,scrollTop:n.pageYOffset}}function Je(n){if(Te(n)==="html")return n;const r=n.assignedSlot||n.parentNode||zn(n)&&n.host||Me(n);return zn(r)?r.host:r}function Br(n){const r=Je(n);return Kt(r)?n.ownerDocument?n.ownerDocument.body:n.body:ve(r)&&gt(r)?r:Br(r)}function ut(n,r,t){var e;r===void 0&&(r=[]),t===void 0&&(t=!0);const a=Br(n),s=a===((e=n.ownerDocument)==null?void 0:e.body),o=ie(a);return s?r.concat(o,o.visualViewport||[],gt(a)?a:[],o.frameElement&&t?ut(o.frameElement):[]):r.concat(a,ut(a,[],t))}function Qr(n){const r=le(n);let t=parseFloat(r.width)||0,e=parseFloat(r.height)||0;const a=ve(n),s=a?n.offsetWidth:t,o=a?n.offsetHeight:e,i=Nt(t)!==s||Nt(e)!==o;return i&&(t=s,e=o),{width:t,height:e,$:i}}function Tn(n){return se(n)?n:n.contextElement}function Ue(n){const r=Tn(n);if(!ve(r))return Ne(1);const t=r.getBoundingClientRect(),{width:e,height:a,$:s}=Qr(r);let o=(s?Nt(t.width):t.width)/e,i=(s?Nt(t.height):t.height)/a;return(!o||!Number.isFinite(o))&&(o=1),(!i||!Number.isFinite(i))&&(i=1),{x:o,y:i}}const ao=Ne(0);function Kr(n){const r=ie(n);return!Nn()||!r.visualViewport?ao:{x:r.visualViewport.offsetLeft,y:r.visualViewport.offsetTop}}function oo(n,r,t){return r===void 0&&(r=!1),!t||r&&t!==ie(n)?!1:r}function je(n,r,t,e){r===void 0&&(r=!1),t===void 0&&(t=!1);const a=n.getBoundingClientRect(),s=Tn(n);let o=Ne(1);r&&(e?se(e)&&(o=Ue(e)):o=Ue(n));const i=oo(s,t,e)?Kr(s):Ne(0);let c=(a.left+i.x)/o.x,l=(a.top+i.y)/o.y,d=a.width/o.x,p=a.height/o.y;if(s){const m=ie(s),h=e&&se(e)?ie(e):e;let y=m,w=y.frameElement;for(;w&&e&&h!==y;){const b=Ue(w),x=w.getBoundingClientRect(),v=le(w),M=x.left+(w.clientLeft+parseFloat(v.paddingLeft))*b.x,N=x.top+(w.clientTop+parseFloat(v.paddingTop))*b.y;c*=b.x,l*=b.y,d*=b.x,p*=b.y,c+=M,l+=N,y=ie(w),w=y.frameElement}}return Ot({width:d,height:p,x:c,y:l})}const so=[":popover-open",":modal"];function zr(n){return so.some(r=>{try{return n.matches(r)}catch{return!1}})}function io(n){let{elements:r,rect:t,offsetParent:e,strategy:a}=n;const s=a==="fixed",o=Me(e),i=r?zr(r.floating):!1;if(e===o||i&&s)return t;let c={scrollLeft:0,scrollTop:0},l=Ne(1);const d=Ne(0),p=ve(e);if((p||!p&&!s)&&((Te(e)!=="body"||gt(o))&&(c=zt(e)),ve(e))){const m=je(e);l=Ue(e),d.x=m.x+e.clientLeft,d.y=m.y+e.clientTop}return{width:t.width*l.x,height:t.height*l.y,x:t.x*l.x-c.scrollLeft*l.x+d.x,y:t.y*l.y-c.scrollTop*l.y+d.y}}function co(n){return Array.from(n.getClientRects())}function Vr(n){return je(Me(n)).left+zt(n).scrollLeft}function lo(n){const r=Me(n),t=zt(n),e=n.ownerDocument.body,a=$e(r.scrollWidth,r.clientWidth,e.scrollWidth,e.clientWidth),s=$e(r.scrollHeight,r.clientHeight,e.scrollHeight,e.clientHeight);let o=-t.scrollLeft+Vr(n);const i=-t.scrollTop;return le(e).direction==="rtl"&&(o+=$e(r.clientWidth,e.clientWidth)-a),{width:a,height:s,x:o,y:i}}function uo(n,r){const t=ie(n),e=Me(n),a=t.visualViewport;let s=e.clientWidth,o=e.clientHeight,i=0,c=0;if(a){s=a.width,o=a.height;const l=Nn();(!l||l&&r==="fixed")&&(i=a.offsetLeft,c=a.offsetTop)}return{width:s,height:o,x:i,y:c}}function po(n,r){const t=je(n,!0,r==="fixed"),e=t.top+n.clientTop,a=t.left+n.clientLeft,s=ve(n)?Ue(n):Ne(1),o=n.clientWidth*s.x,i=n.clientHeight*s.y,c=a*s.x,l=e*s.y;return{width:o,height:i,x:c,y:l}}function Vn(n,r,t){let e;if(r==="viewport")e=uo(n,t);else if(r==="document")e=lo(Me(n));else if(se(r))e=po(r,t);else{const a=Kr(n);e={...r,x:r.x-a.x,y:r.y-a.y}}return Ot(e)}function qr(n,r){const t=Je(n);return t===r||!se(t)||Kt(t)?!1:le(t).position==="fixed"||qr(t,r)}function fo(n,r){const t=r.get(n);if(t)return t;let e=ut(n,[],!1).filter(i=>se(i)&&Te(i)!=="body"),a=null;const s=le(n).position==="fixed";let o=s?Je(n):n;for(;se(o)&&!Kt(o);){const i=le(o),c=En(o);!c&&i.position==="fixed"&&(a=null),(s?!c&&!a:!c&&i.position==="static"&&!!a&&["absolute","fixed"].includes(a.position)||gt(o)&&!c&&qr(n,o))?e=e.filter(d=>d!==o):a=i,o=Je(o)}return r.set(n,e),e}function ho(n){let{element:r,boundary:t,rootBoundary:e,strategy:a}=n;const o=[...t==="clippingAncestors"?fo(r,this._c):[].concat(t),e],i=o[0],c=o.reduce((l,d)=>{const p=Vn(r,d,a);return l.top=$e(p.top,l.top),l.right=Ge(p.right,l.right),l.bottom=Ge(p.bottom,l.bottom),l.left=$e(p.left,l.left),l},Vn(r,i,a));return{width:c.right-c.left,height:c.bottom-c.top,x:c.left,y:c.top}}function mo(n){const{width:r,height:t}=Qr(n);return{width:r,height:t}}function go(n,r,t){const e=ve(r),a=Me(r),s=t==="fixed",o=je(n,!0,s,r);let i={scrollLeft:0,scrollTop:0};const c=Ne(0);if(e||!e&&!s)if((Te(r)!=="body"||gt(a))&&(i=zt(r)),e){const p=je(r,!0,s,r);c.x=p.x+r.clientLeft,c.y=p.y+r.clientTop}else a&&(c.x=Vr(a));const l=o.left+i.scrollLeft-c.x,d=o.top+i.scrollTop-c.y;return{x:l,y:d,width:o.width,height:o.height}}function qn(n,r){return!ve(n)||le(n).position==="fixed"?null:r?r(n):n.offsetParent}function Ur(n,r){const t=ie(n);if(!ve(n)||zr(n))return t;let e=qn(n,r);for(;e&&no(e)&&le(e).position==="static";)e=qn(e,r);return e&&(Te(e)==="html"||Te(e)==="body"&&le(e).position==="static"&&!En(e))?t:e||ro(n)||t}const yo=async function(n){const r=this.getOffsetParent||Ur,t=this.getDimensions;return{reference:go(n.reference,await r(n.floating),n.strategy),floating:{x:0,y:0,...await t(n.floating)}}};function wo(n){return le(n).direction==="rtl"}const Xr={convertOffsetParentRelativeRectToViewportRelativeRect:io,getDocumentElement:Me,getClippingRect:ho,getOffsetParent:Ur,getElementRects:yo,getClientRects:co,getDimensions:mo,getScale:Ue,isElement:se,isRTL:wo};function bo(n,r){let t=null,e;const a=Me(n);function s(){var i;clearTimeout(e),(i=t)==null||i.disconnect(),t=null}function o(i,c){i===void 0&&(i=!1),c===void 0&&(c=1),s();const{left:l,top:d,width:p,height:m}=n.getBoundingClientRect();if(i||r(),!p||!m)return;const h=bt(d),y=bt(a.clientWidth-(l+p)),w=bt(a.clientHeight-(d+m)),b=bt(l),v={rootMargin:-h+"px "+-y+"px "+-w+"px "+-b+"px",threshold:$e(0,Ge(1,c))||1};let M=!0;function N(S){const T=S[0].intersectionRatio;if(T!==c){if(!M)return o();T?o(!1,T):e=setTimeout(()=>{o(!1,1e-7)},100)}M=!1}try{t=new IntersectionObserver(N,{...v,root:a.ownerDocument})}catch{t=new IntersectionObserver(N,v)}t.observe(n)}return o(!0),s}function vo(n,r,t,e){e===void 0&&(e={});const{ancestorScroll:a=!0,ancestorResize:s=!0,elementResize:o=typeof ResizeObserver=="function",layoutShift:i=typeof IntersectionObserver=="function",animationFrame:c=!1}=e,l=Tn(n),d=a||s?[...l?ut(l):[],...ut(r)]:[];d.forEach(x=>{a&&x.addEventListener("scroll",t,{passive:!0}),s&&x.addEventListener("resize",t)});const p=l&&i?bo(l,t):null;let m=-1,h=null;o&&(h=new ResizeObserver(x=>{let[v]=x;v&&v.target===l&&h&&(h.unobserve(r),cancelAnimationFrame(m),m=requestAnimationFrame(()=>{var M;(M=h)==null||M.observe(r)})),t()}),l&&!c&&h.observe(l),h.observe(r));let y,w=c?je(n):null;c&&b();function b(){const x=je(n);w&&(x.x!==w.x||x.y!==w.y||x.width!==w.width||x.height!==w.height)&&t(),w=x,y=requestAnimationFrame(b)}return t(),()=>{var x;d.forEach(v=>{a&&v.removeEventListener("scroll",t),s&&v.removeEventListener("resize",t)}),p==null||p(),(x=h)==null||x.disconnect(),h=null,c&&cancelAnimationFrame(y)}}const xo=Ja,Un=Za,Do=(n,r,t)=>{const e=new Map,a={platform:Xr,...t},s={...a.platform,_c:e};return Xa(n,r,{...a,platform:s})},ko=n=>{function r(t){return{}.hasOwnProperty.call(t,"current")}return{name:"arrow",options:n,fn(t){const{element:e,padding:a}=typeof n=="function"?n(t):n;return e&&r(e)?e.current!=null?Un({element:e.current,padding:a}).fn(t):{}:e?Un({element:e,padding:a}).fn(t):{}}}};var _t=typeof document<"u"?D.useLayoutEffect:D.useEffect;function Yt(n,r){if(n===r)return!0;if(typeof n!=typeof r)return!1;if(typeof n=="function"&&n.toString()===r.toString())return!0;let t,e,a;if(n&&r&&typeof n=="object"){if(Array.isArray(n)){if(t=n.length,t!==r.length)return!1;for(e=t;e--!==0;)if(!Yt(n[e],r[e]))return!1;return!0}if(a=Object.keys(n),t=a.length,t!==Object.keys(r).length)return!1;for(e=t;e--!==0;)if(!{}.hasOwnProperty.call(r,a[e]))return!1;for(e=t;e--!==0;){const s=a[e];if(!(s==="_owner"&&n.$$typeof)&&!Yt(n[s],r[s]))return!1}return!0}return n!==n&&r!==r}function Gr(n){return typeof window>"u"?1:(n.ownerDocument.defaultView||window).devicePixelRatio||1}function Xn(n,r){const t=Gr(n);return Math.round(r*t)/t}function Gn(n){const r=D.useRef(n);return _t(()=>{r.current=n}),r}function Mo(n){n===void 0&&(n={});const{placement:r="bottom",strategy:t="absolute",middleware:e=[],platform:a,elements:{reference:s,floating:o}={},transform:i=!0,whileElementsMounted:c,open:l}=n,[d,p]=D.useState({x:0,y:0,strategy:t,placement:r,middlewareData:{},isPositioned:!1}),[m,h]=D.useState(e);Yt(m,e)||h(e);const[y,w]=D.useState(null),[b,x]=D.useState(null),v=D.useCallback(j=>{j!==T.current&&(T.current=j,w(j))},[]),M=D.useCallback(j=>{j!==_.current&&(_.current=j,x(j))},[]),N=s||y,S=o||b,T=D.useRef(null),_=D.useRef(null),E=D.useRef(d),Y=c!=null,ne=Gn(c),J=Gn(a),A=D.useCallback(()=>{if(!T.current||!_.current)return;const j={placement:r,strategy:t,middleware:m};J.current&&(j.platform=J.current),Do(T.current,_.current,j).then(Qe=>{const Ke={...Qe,isPositioned:!0};re.current&&!Yt(E.current,Ke)&&(E.current=Ke,Fr.flushSync(()=>{p(Ke)}))})},[m,r,t,J]);_t(()=>{l===!1&&E.current.isPositioned&&(E.current.isPositioned=!1,p(j=>({...j,isPositioned:!1})))},[l]);const re=D.useRef(!1);_t(()=>(re.current=!0,()=>{re.current=!1}),[]),_t(()=>{if(N&&(T.current=N),S&&(_.current=S),N&&S){if(ne.current)return ne.current(N,S,A);A()}},[N,S,A,ne,Y]);const V=D.useMemo(()=>({reference:T,floating:_,setReference:v,setFloating:M}),[v,M]),z=D.useMemo(()=>({reference:N,floating:S}),[N,S]),ae=D.useMemo(()=>{const j={position:t,left:0,top:0};if(!z.floating)return j;const Qe=Xn(z.floating,d.x),Ke=Xn(z.floating,d.y);return i?{...j,transform:"translate("+Qe+"px, "+Ke+"px)",...Gr(z.floating)>=1.5&&{willChange:"transform"}}:{position:t,left:Qe,top:Ke}},[t,i,z.floating,d.x,d.y]);return D.useMemo(()=>({...d,update:A,refs:V,elements:z,floatingStyles:ae}),[d,A,V,z,ae])}const Co=P.h3`
...
`,ct=P.p`
  ...
  line-height: 1.28571;
  color: ${({theme:n})=>n.color.red};
`,Oo=n=>n.water.month,Yo=n=>n.water.dayInfo,Ro=n=>{var r;return(r=n.water.dayInfo)==null?void 0:r.drinks},Io=n=>{var r;return(r=n.water.dayInfo)==null?void 0:r.consumedWaterPercentage},Lo=n=>{var r;return(r=n.water.dayInfo)==null?void 0:r.dailyWaterGoal},$o=n=>n.water.dayDataLoading,Fo=({closeModal:n})=>{const t=(ge(Lo)/1e3).toFixed(1),[e,a]=D.useState("");console.log("🚀 ~ dailyWaterNorm:",e);const[s,o]=D.useState(!0),i=15,c=p=>{const{value:m}=p.target,h=/^(\d+([.,]\d{0,1})?)?$/;var y=m;m.match(/^[.,]/)?y="0"+m:y=m.replace(/^0+([^.])/,"$1"),o(y===""||parseFloat(y.replace(",","."))<=i),h.test(y)&&a(y)},l=He(),d=async p=>{if(p.preventDefault(),!s||e<=0)return;const m=p.target.elements.dailyNorm.value*1e3;try{const{payload:h}=await l(Na(m));h.user&&(l(jr()),n())}catch(h){console.log("🚀 ~ error:",h)}};return f.jsxs("form",{onSubmit:d,children:[f.jsxs(No,{children:["Write down how much water you will drink:",f.jsx(dn,{className:!s&&e<=0?"error":"",type:"number",name:"dailyNorm",value:e,onChange:c,placeholder:t}),!s&&f.jsx(ct,{children:`The water rate cannot exceed ${i} liters`}),e<0&&f.jsx(ct,{children:"The water rate cannot be negative"}),parseFloat(e)===0&&f.jsx(ct,{children:"The water rate cannot be 0"})]}),f.jsx(To,{className:"confirm",type:"submit",children:"Save"})]})},jo=()=>{const n=ge(Ta),[r,t]=D.useState(n),[e,a]=D.useState(""),[s,o]=D.useState(""),[i,c]=D.useState(!0),[l,d]=D.useState(!0),p=ge(Oa)?"dark":"light",h=`radio-${r==="woman"?"active":"inactive"}-${p}`,w=`radio-${r==="man"?"active":"inactive"}-${p}`,b=300,x=12,v=S=>{const{name:T,value:_}=S.target,E=/^(\d+([.,]\d{0,1})?)?$/;var Y=_;switch(T){case"gender":t(_);break;case"weight":_.match(/^[.,]/)?Y="0"+_:Y=_.replace(/^0+([^.])/,"$1"),c(Y===""||parseFloat(Y.replace(",","."))<=b),E.test(Y)&&a(Y);break;case"activeHours":_.match(/^[.,]/)?Y="0"+_:Y=_.replace(/^0+([^.])/,"$1"),d(Y===""||parseFloat(Y.replace(",","."))<=x),E.test(Y)&&o(Y);break}},M=r==="woman"?e*.03+s*.4:e*.04+s*.6,N=Math.round(M*10)/10;return f.jsx("div",{children:f.jsxs("form",{action:"",children:[f.jsx(Co,{children:"Calculate your rate:"}),f.jsxs(_o,{children:[f.jsxs(Zn,{children:[f.jsx(Jn,{id:"woman",type:"radio",name:"gender",value:"woman",checked:r==="woman",onChange:v}),f.jsxs(er,{htmlFor:"woman",children:[f.jsx(tr,{children:f.jsx(nr,{children:f.jsx("use",{href:`${qe}#${h}`})})}),"For woman"]})]}),f.jsxs(Zn,{children:[f.jsx(Jn,{id:"man",type:"radio",name:"gender",value:"man",checked:r==="man",onChange:v}),f.jsxs(er,{htmlFor:"man",children:[f.jsx(tr,{children:f.jsx(nr,{children:f.jsx("use",{href:`${qe}#${w}`})})}),"For man"]})]})]}),f.jsxs(rr,{children:["Your weight in kilograms:",f.jsx(dn,{className:i?"":"error",type:"number",name:"weight",value:e,onChange:v,placeholder:"0"}),!i&&f.jsx(ct,{children:`Weight cannot exceed ${b} kg`})]}),f.jsxs(rr,{children:["The time of active participation in sports or other activities with a high physical. load in hours:",f.jsx(dn,{className:l?"":"error",type:"number",name:"activeHours",value:s,onChange:v,placeholder:"0"}),!l&&f.jsx(ct,{children:`Active hours cannot exceed ${x} hours`})]}),f.jsxs(So,{children:[f.jsxs(Po,{children:["The required amount of water in liters per day:"," "]}),i&&l&&f.jsxs(Eo,{children:[N," L"]})]})]})})},Wo=P.div`
  display: flex;
  flex-direction: column;
  gap: 24px;
...
`,Jo=P.div`
  display: flex;
  gap: 12px;
`,es=()=>{const{dailyWaterGoal:n}=ge(Ya),[r,t]=D.useState(!1),e=He(),a=()=>{t(!0)},s=()=>{t(!1)},o=(n/1e3).toFixed(1)+" L";return D.useEffect(()=>{e(jr())},[e]),f.jsxs(Uo,{children:[f.jsx(Xo,{children:"My daily norma: "}),f.jsxs(Jo,{children:[f.jsx(Zo,{children:o}),f.jsx(Go,{onClick:a,children:"Edit"})]}),f.jsx(qo,{isModalOpen:r,closeModal:s})]})},ts=P.div`
  display: flex;
  height: 90px;
  flex-direction: column;
  align-items: flex-start;
...
`,iu=({isModalOpen:n,closeModal:r})=>{const[t,e]=D.useState(50),[a,s]=D.useState(new Date),o=He(),i=()=>{e(m=>m+50)},c=()=>{t>=50&&e(m=>m-50)},l=m=>{s(m)},d=m=>{m.preventDefault();const h=a.getTimezoneOffset();o(Ia({date:a,ml:t,timeZoneOffset:h}))},p=m=>{const h=parseInt(m.target.value);e(h)};return f.jsx(f.Fragment,{children:n&&f.jsx(Mn,{onClose:r,children:f.jsxs(su,{children:[f.jsxs("div",{className:"topline",children:[f.jsx("h2",{children:"Add water"}),f.jsx(kn,{className:"close",onClick:r})]}),f.jsx("p",{children:"Choose of water:"}),f.jsxs("form",{onSubmit:d,children:[f.jsxs("label",{children:["Amount of water:",f.jsxs("div",{className:"counter",children:[f.jsx("button",{className:"counterBtn",type:"button",onClick:i,children:f.jsx(Yn,{})}),f.jsxs("span",{className:"waterAmount",children:[t,"ml"]}),f.jsx("button",{className:"counterBtn",type:"button",onClick:c,children:f.jsx(In,{})})]})]}),f.jsxs("label",{children:["Recording time:",f.jsx(Ca,{className:"input",selected:a,onChange:m=>l(m),showTimeSelect:!0,showTimeSelectOnly:!0,timeFormat:"HH:mm",dateFormat:"HH:mm"})]}),f.jsxs("label",{children:["Enter the value of the water used:",f.jsx("input",{className:"input",type:"number",value:t,onChange:p})]}),f.jsxs("div",{className:"buttons",children:[f.jsxs("span",{className:"amount",children:[t,"ml"]}),f.jsx("button",{className:"confirm",type:"submit",onClick:d,children:"Save"})]})]})]})})})},cu=()=>{const[n,r]=D.useState(!1),t=ge(Io),e=He(),a=()=>{r(!0)},s=()=>{r(!1)},o=t>100?100:t;return D.useEffect(()=>{e(La())},[e]),f.jsx(f.Fragment,{children:f.jsxs(ts,{children:[f.jsx("h3",{children:"Today"}),f.jsxs("div",{className:"box",children:[f.jsx(ns,{children:f.jsx("div",{className:"progress-bar-container",children:f.jsxs("div",{className:"progress-bar",children:[f.jsx("div",{className:"progress",style:{width:`${o}%`}}),f.jsx("div",{className:"line-0",children:"|"}),f.jsx("div",{className:"line-50",children:"|"}),f.jsx("div",{className:"line-100",children:"|"}),f.jsx("div",{className:"marker-0",children:"0%"}),f.jsx("div",{className:"marker-50",children:"50%"}),f.jsx("div",{className:"marker-100",children:"100%"}),f.jsx("div",{className:"indicator",style:{left:`${o}%`},children:f.jsx("p",{className:"progress-text",children:t>100?`${t}%`:`${o}%`})})]})})}),f.jsxs(rs,{onClick:a,children:[f.jsx(as,{width:"20px",height:"20px",children:f.jsx("use",{xlinkHref:`${qe}#plus-circle`})})," ",f.jsx("p",{children:"Add Water"})]})]}),n&&f.jsx(iu,{isModalOpen:n,closeModal:s})]})})},lu=P.div`
  *::-webkit-scrollbar {
    width: 4px;
  }
...
`,du=({isModalOpen:n,closeModal:r})=>{const[t,e]=D.useState(50),[a,s]=D.useState(""),{id:o,ml:i,time:c}=ge(Ro),l=He(),d=()=>{e(w=>w+50)},p=()=>{t>=50&&e(w=>w-50)},m=w=>{s(w)},h=w=>{w.preventDefault();const b={time:a,ml:t};console.log(b),l($a({id:o,data:b}))},y=w=>{const b=parseInt(w.target.value);e(b)};return f.jsx(f.Fragment,{children:n&&f.jsx(Mn,{onClose:r,children:f.jsxs(uu,{children:[f.jsxs("div",{className:"topline",children:[f.jsx("h2",{children:"Edit the entered amount of water"}),f.jsx(kn,{className:"close",onClick:r})]}),f.jsxs("span",{className:"amount",children:[i,"ml"]}),c,f.jsx("p",{children:"Correct entered data:"}),f.jsxs("form",{onSubmit:h,children:[f.jsxs("label",{children:["Amount of water:",f.jsxs("div",{className:"counter",children:[f.jsx("button",{className:"counterBtn",type:"button",onClick:d,children:f.jsx(Yn,{})}),f.jsxs("span",{className:"waterAmount",children:[t,"ml"]}),f.jsx("button",{className:"counterBtn",type:"button",onClick:p,children:f.jsx(In,{})})]})]}),f.jsxs("label",{children:["Recording time:",f.jsx(Ca,{className:"input",selected:a,onChange:w=>m(w),showTimeSelect:!0,showTimeSelectOnly:!0,timeFormat:"HH:mm",dateFormat:"HH:mm"})]}),f.jsxs("label",{children:["Enter the value of the water used:",f.jsx("input",{className:"input",type:"number",value:t,onChange:y})]}),f.jsxs("div",{className:"buttons",children:[f.jsxs("span",{className:"amount",children:[t,"ml"]}),f.jsx("button",{className:"confirm",type:"submit",onClick:h,children:"Save"})]})]})]})})})},pu=()=>{const[n,r]=D.useState(!1);ge(Yo);const t=He(),e=[{id:1,volume:"200 ml",date:14.02},{id:2,volume:"200 ml",date:14.45},{id:3,volume:"150 ml",date:16.12},{id:4,volume:"50 ml",date:18.01},{id:5,volume:"300 ml",date:19.03},{id:6,volume:"100 ml",date:21.05},{id:7,volume:"5 ml",date:22.05}],a=i=>{r(!0)},s=()=>{r(!1)},o=i=>{console.dir(i.target.closest("LI").id),t(Fa(i.target.closest("LI").id))};return f.jsxs(f.Fragment,{children:[f.jsxs(lu,{children:[f.jsx("h3",{className:"title",children:"Today"}),f.jsx("ul",{className:"waterList",children:e.length>0?e.map(i=>f.jsxs("li",{className:"waterItem",id:i.id,children:[f.jsxs("div",{className:"volumeAdnDate",children:[f.jsx("svg",{className:"waterGlass",width:"26",height:"26",stroke:"#9ebbff",fill:"none",children:f.jsx("use",{href:qe+"#water-glass"})}),f.jsx("span",{className:"waterVolume",children:i.volume}),f.jsx("span",{className:"waterTime",children:i.date})]}),f.jsxs("div",{className:"editDelete",children:[f.jsx("svg",{onClick:a,width:"16",height:"13",stroke:"#9ebbff",fill:"none",children:f.jsx("use",{href:qe+"#pencil-square"})}),f.jsx("svg",{onClick:o,width:"16",height:"16",stroke:"#ef5050",fill:"none",children:f.jsx("use",{href:qe+"#trash"})})]})]},i.id)):f.jsx("p",{children:"You don't have records on this day"})}),f.jsx("h3",{className:"addWater",children:"+ Add water"})]}),n&&f.jsx(du,{isModalOpen:n,closeModal:s})]})};var Bn={},fu=Bt;Object.defineProperty(Bn,"__esModule",{value:!0});var _a=Bn.default=void 0,hu=fu(Ht()),mu=f;_a=Bn.default=(0,hu.default)((0,mu.jsx)("path",{d:"M6.23 20.23 8 22l10-10L8 2 6.23 3.77 14.46 12z"}),"ArrowForwardIos");var Qn={},gu=Bt;Object.defineProperty(Qn,"__esModule",{value:!0});var Sa=Qn.default=void 0,yu=gu(Ht()),wu=f;Sa=Qn.default=(0,yu.default)((0,wu.jsx)("path",{d:"M11.67 3.87 9.9 2.1 0 12l9.9 9.9 1.77-1.77L3.54 12z"}),"ArrowBackIos");const bu=P.div`
  display: flex;
  flex-direction: column;
  gap: 16px;
  width: 280px;
...
`,vu=({calendarRef:n,refData:r,waterData:t={}})=>{const{dayOfMonth:e,waterRate:a,percent:s,numberRecords:o}=t,i=r==null?void 0:r.current.getBoundingClientRect().left,c=n==null?void 0:n.current.getBoundingClientRect().left;let l=!0;const d=i-c;return d<200&&(l=!1),f.jsx(bu,{$delta:l,$deltaNum:d,children:Object.values(t).length?f.jsxs(f.Fragment,{children:[f.jsx("h3",{children:e}),f.jsxs("p",{children:["Daily norma: ",f.jsxs("span",{children:[a/1e3," L"]})]}),f.jsxs("p",{children:["Fulfillment of the daily norm:"," ",f.jsxs("span",{children:[s>100?100:s,"%"]})]}),f.jsxs("p",{children:["How many servings of water: ",f.jsx("span",{children:o})]})]}):f.jsx("h3",{children:"You don't have records on this day."})})},xu=P.div`
  display: flex;
  flex-direction: column;
`,Du=P.div`
  display: flex;
...
`,Eu=P.div`
  ...
  align-items: center;
  position: relative;
`,Nu=({calendarRef:n,day:r,consumedWaterPercentage:t})=>{const[e,a]=D.useState(null),s=D.useRef(null),o=c=>{s.current&&!s.current.contains(c.target)&&a(null)};D.useEffect(()=>(document.addEventListener("click",o),()=>{document.removeEventListener("click",o)}),[]);const i=()=>{a(c=>c===r?null:r)};return f.jsxs(Eu,{children:[f.jsx("div",{children:e===r&&f.jsx(vu,{calendarRef:n,refData:s,waterDay:t},r)}),f.jsx(Mu,{ref:s,onClick:()=>i(),$isOutlineVisible:!t||t.percent<100,children:r}),f.jsx(Su,{children:t?`${Math.min(t.percent,100)}%`:"0%"})]},r)},Tu="#4fa94d",Ou={"aria-busy":!0,role:"progressbar"},Yu=P.div`
  display: ${n=>n.$visible?"flex":"none"};
`,Ru="http://www.w3.org/2000/svg",ue=242.776657104492,Iu=1.6,Lu=Cn`
12.5% {
...
`;P.path`
  ...
  stroke-dashoffset: 0;
  animation: ${Lu} ${Iu}s linear infinite;
`;const $u=Cn`
to {
...
`;const Fu=({height:n=80,width:r=80,radius:t=9,color:e=Tu,ariaLabel:a="three-dots-loading",wrapperStyle:s,wrapperClass:o,visible:i=!0})=>f.jsx(Yu,{style:s,$visible:i,className:o,"data-testid":"three-dots-loading","aria-label":a,...Ou,children:f.jsxs("svg",{width:r,height:n,viewBox:"0 0 120 30",xmlns:Ru,fill:e,"data-testid":"three-dots-svg",children:[f.jsxs("circle",{cx:"15",cy:"15",r:Number(t)+6,children:[f.jsx("animate",{attributeName:"r",from:"15",to:"15",begin:"0s",dur:"0.8s",values:"15;9;15",calcMode:"linear",repeatCount:"indefinite"}),f.jsx("animate",{attributeName:"fill-opacity",from:"1",to:"1",begin:"0s",dur:"0.8s",values:"1;.5;1",calcMode:"linear",repeatCount:"indefinite"})]}),f.jsxs("circle",{cx:"60",cy:"15",r:t,attributeName:"fill-opacity",from:"1",to:"0.3",children:[f.jsx("animate",{attributeName:"r",from:"9",to:"9",begin:"0s",dur:"0.8s",values:"9;15;9",calcMode:"linear",repeatCount:"indefinite"}),f.jsx("animate",{attributeName:"fill-opacity",from:"0.5",to:"0.5",begin:"0s",dur:"0.8s",values:".5;1;.5",calcMode:"linear",repeatCount:"indefinite"})]}),f.jsxs("circle",{cx:"105",cy:"15",r:Number(t)+6,children:[f.jsx("animate",{attributeName:"r",from:"15",to:"15",begin:"0s",dur:"0.8s",values:"15;9;15",calcMode:"linear",repeatCount:"indefinite"}),f.jsx("animate",{attributeName:"fill-opacity",from:"1",to:"1",begin:"0s",dur:"0.8s",values:"1;.5;1",calcMode:"linear",repeatCount:"indefinite"})]})]})}),ju=Cn`
to {
   stroke-dashoffset: 136;
 }
`;P.polygon`
  stroke-dasharray: 17;
  animation: ${ju} 2.5s cubic-bezier(0.35, 0.04, 0.63, 0.95) infinite;
`;P.svg`
  transform-origin: 50% 65%;
`;const ln={colors:{white:"#FFFFFF",black:"#2F2F2F",blue:"#407BFF",red:"#EF5050",orange:"#FF9D43",grey:"#ECF2FF",violet:"#9EBBFF",violet_light:"#D7E3FF"},animation:{duration:"0.3s",cubicBezier:"cubic-bezier(0.5, 0, 0.2, 1)"}},Wu=()=>{const[n,r]=D.useState(new Date),t=He(),e=D.useRef(null),a=ge(m=>m.getCurrentNorm),s=ge(Oo),o=ge($o);D.useEffect(()=>{const m=new Date(n.getFullYear(),n.getMonth(),2),h=new Date(n.getFullYear(),n.getMonth()+1,1),y=m.toISOString().split("T")[0],w=h.toISOString().split("T")[0],b={startDate:y,endDate:w};t(ja(b)),console.log(b)},[t,n,a]);const i=()=>{const m=new Date(n.getFullYear(),n.getMonth()+1,1);r(m)},c=()=>{const m=new Date(n.getFullYear(),n.getMonth()-1,1);r(m)},l=()=>{const m=new Date;return n.getMonth()===m.getMonth()&&n.getFullYear()===m.getFullYear()},d=()=>new Date(n.getFullYear(),n.getMonth()+1,0).getDate(),p=()=>{const m=d();return Array.from({length:m},(h,y)=>{var x;const w=y+1,b=s&&((x=s[y])==null?void 0:x.consumedWaterPercentage);return f.jsx(Nu,{dailyWaterGoal:e,day:w,consumedWaterPercentage:b},w)})};return f.jsxs(xu,{className:"calendar",ref:e,children:[f.jsxs(Du,{children:[f.jsx(ku,{children:"Month"}),o&&f.jsx(Fu,{height:"60",width:"60",radius:"9",color:ln.colors.blue,ariaLabel:"three-dots-loading",wrapperStyle:{height:"30px",width:"40px",display:"flex",alignItems:"center",justifyContent:"center"},wrapperClassName:"",visible:!0}),f.jsxs(Cu,{children:[f.jsx($r,{"aria-label":"Previous month",onClick:c,children:f.jsx(Sa,{sx:{color:ln.colors.blue}})}),f.jsx(_u,{children:`${new Intl.DateTimeFormat("en-US",{month:"long"}).format(n)}, ${n.getFullYear()}`}),f.jsx($r,{"aria-label":"Next month",onClick:i,disabled:l(),children:f.jsx(_a,{sx:{color:ln.colors.blue}})})]})]}),f.jsx(Pu,{children:p()})]})},Au=P.div`
...
`,Vu=()=>f.jsx(Au,{children:f.jsx(Wa,{children:f.jsxs(Hu,{children:[f.jsxs(Bu,{children:[f.jsx(es,{}),f.jsx(cu,{})]}),f.jsxs(Qu,{children:[f.jsx(pu,{}),f.jsx(Wu,{})]})]})})});export{Vu as default};
