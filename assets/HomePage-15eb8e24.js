...
`,Nt=P.p`
  ...
  line-height: 1.28571;
  color: ${({theme:n})=>n.color.red};
`,Ds=n=>n.water.month,Ao=n=>n.water.dayInfo,ks=n=>{var r;return(r=n.water.dayInfo)==null?void 0:r.consumedWaterPercentage},Cs=n=>{var r;return(r=n.water.dayInfo)==null?void 0:r.dailyWaterGoal},Ms=n=>n.water.dayDataLoading,_s=({closeModal:n})=>{const t=(Ye(Cs)/1e3).toFixed(1),[e,o]=D.useState(""),[s,a]=D.useState(!0),i=15,c=p=>{const{value:h}=p.target,m=/^(\d+([.,]\d{0,1})?)?$/;var g=h;h.match(/^[.,]/)?g="0"+h:g=h.replace(/^0+([^.])/,"$1"),a(g===""||parseFloat(g.replace(",","."))<=i),m.test(g)&&o(g)},l=ct(),u=async p=>{if(p.preventDefault(),!s||e<=0)return;const h=p.target.elements.dailyNorm.value*1e3;try{const{payload:m}=await l(ba(h));m.user&&(l(_o()),n())}catch(m){console.log("🚀 ~ error:",m)}};return f.jsxs("form",{onSubmit:u,children:[f.jsxs(bs,{children:["Write down how much water you will drink:",f.jsx(Kn,{className:!s&&e<=0?"error":"",type:"number",name:"dailyNorm",value:e,onChange:c,placeholder:t}),!s&&f.jsx(Nt,{children:`The water rate cannot exceed ${i} liters`}),e<0&&f.jsx(Nt,{children:"The water rate cannot be negative"}),parseFloat(e)===0&&f.jsx(Nt,{children:"The water rate cannot be 0"})]}),f.jsx(xs,{className:"confirm",type:"submit",children:"Save"})]})},Ss=()=>{const n=Ye(xa),[r,t]=D.useState(n),[e,o]=D.useState(""),[s,a]=D.useState(""),[i,c]=D.useState(!0),[l,u]=D.useState(!0),p=Ye(Da)?"dark":"light",m=`radio-${r==="woman"?"active":"inactive"}-${p}`,w=`radio-${r==="man"?"active":"inactive"}-${p}`,v=300,x=12,b=M=>{const{name:N,value:C}=M.target,E=/^(\d+([.,]\d{0,1})?)?$/;var T=C;switch(N){case"gender":t(C);break;case"weight":C.match(/^[.,]/)?T="0"+C:T=C.replace(/^0+([^.])/,"$1"),c(T===""||parseFloat(T.replace(",","."))<=v),E.test(T)&&o(T);break;case"activeHours":C.match(/^[.,]/)?T="0"+C:T=C.replace(/^0+([^.])/,"$1"),u(T===""||parseFloat(T.replace(",","."))<=x),E.test(T)&&a(T);break}},k=r==="woman"?e*.03+s*.4:e*.04+s*.6,O=Math.round(k*10)/10;return f.jsx("div",{children:f.jsxs("form",{action:"",children:[f.jsx(ms,{children:"Calculate your rate:"}),f.jsxs(gs,{children:[f.jsxs(Rr,{children:[f.jsx(Yr,{id:"woman",type:"radio",name:"gender",value:"woman",checked:r==="woman",onChange:b}),f.jsxs(Ir,{htmlFor:"woman",children:[f.jsx($r,{children:f.jsx(Lr,{children:f.jsx("use",{href:`${Ie}#${m}`})})}),"For woman"]})]}),f.jsxs(Rr,{children:[f.jsx(Yr,{id:"man",type:"radio",name:"gender",value:"man",checked:r==="man",onChange:b}),f.jsxs(Ir,{htmlFor:"man",children:[f.jsx($r,{children:f.jsx(Lr,{children:f.jsx("use",{href:`${Ie}#${w}`})})}),"For man"]})]})]}),f.jsxs(jr,{children:["Your weight in kilograms:",f.jsx(Kn,{className:i?"":"error",type:"number",name:"weight",value:e,onChange:b,placeholder:"0"}),!i&&f.jsx(Nt,{children:`Weight cannot exceed ${v} kg`})]}),f.jsxs(jr,{children:["The time of active participation in sports or other activities with a high physical. load in hours:",f.jsx(Kn,{className:l?"":"error",type:"number",name:"activeHours",value:s,onChange:b,placeholder:"0"}),!l&&f.jsx(Nt,{children:`Active hours cannot exceed ${x} hours`})]}),f.jsxs(ws,{children:[f.jsxs(ys,{children:["The required amount of water in liters per day:"," "]}),i&&l&&f.jsxs(vs,{children:[O," L"]})]})]})})},Ps=P.div`
  display: flex;
  flex-direction: column;
  gap: 24px;
...
`,Is=P.span`
  color: ${({theme:n})=>n.color.blue};
`,$s=({isModalOpen:n,closeModal:r})=>f.jsx(f.Fragment,{children:n&&f.jsx(wn,{onClose:r,children:f.jsxs(Ps,{children:[f.jsxs("div",{children:[f.jsxs(Es,{className:"topline",children:[f.jsx(Os,{children:"My daily norm"}),f.jsx(Ns,{className:"close",onClick:r})]}),f.jsxs(Ts,{children:[f.jsxs(Fr,{children:["For woman: ",f.jsx(Wr,{children:"V=(M*0,03) + (T*0,4)"})]}),f.jsxs(Fr,{children:["For man: ",f.jsx(Wr,{children:"V=(M*0,04) + (T*0,6)"})]})]}),f.jsx(Rs,{children:f.jsxs(Ys,{children:[f.jsx(Is,{children:"*"})," V is the volume of the water norm in liters per day, M is your body weight, T is the time of active sports, or another type of activity commensurate in terms of loads (in the absence of these, you must set 0)"]})})]}),f.jsx("div",{children:f.jsx(Ss,{})}),f.jsx("div",{children:f.jsx(_s,{closeModal:r})})]})})}),Ls=P.div`
  position: relative;
`,js=P.div`
  display: inline-flex;
  padding: 8px 20px;
...
`,np=()=>f.jsx(Oa,{children:f.jsx(qd,{children:f.jsxs(Ud,{children:[f.jsxs(Xd,{children:[f.jsx(qs,{}),f.jsx(td,{})]}),f.jsx(Gd,{children:f.jsxs(Zd,{children:[f.jsx(ud,{}),f.jsx(Vd,{})]})})]})})});export{np as default};
