...
`;a.svg`
  animation: ${ye} 0.75s steps(12, end) infinite;
...
`;const $e=n=>{const[t,i]=u.useState(new Date),[s]=u.useState(),l=F(),r=u.useRef(null),c=v(te);u.useEffect(()=>{const o=`${t.getMonth()+1} - ${t.getFullYear()}`;l(W(o))},[l,t,n]);const d=()=>{const o=new Date(t.getFullYear(),t.getMonth()+1,1);i(o)},h=()=>{const o=new Date(t.getFullYear(),t.getMonth()-1,1);i(o)},p=()=>{const o=new Date;return t.getMonth()===o.getMonth()&&t.getFullYear()===o.getFullYear()},x=()=>new Date(t.getFullYear(),t.getMonth()+1,0).getDate(),b=()=>{const o=x();return Array.from({length:o},(j,g)=>{const y=g+1,R=c==null?void 0:c.find(M=>M.dayOfMonth&&Number(M.dayOfMonth.split(",")[0])===y);return e.jsx(xe,{calendarRef:r,day:y,waterPercentage:R},y)})};return e.jsxs(ae,{className:"calendar",ref:r,children:[e.jsxs(re,{children:[e.jsx(oe,{children:"Month"}),s&&e.jsx(ve,{height:"60",width:"60",radius:"9",color:m.colors.blue,ariaLabel:"three-dots-loading",wrapperStyle:{height:"30px",width:"40px",display:"flex",alignItems:"center",justifyContent:"center"},wrapperClassName:"",visible:!0}),e.jsxs(le,{children:[e.jsx(C,{"aria-label":"Previous month",onClick:h,children:e.jsx(L,{sx:{color:m.colors.blue}})}),e.jsx(ce,{children:`${new Intl.DateTimeFormat("en-US",{month:"long"}).format(t)}, ${t.getFullYear()}`}),e.jsx(C,{"aria-label":"Next month",onClick:d,disabled:p(),children:e.jsx(z,{sx:{color:m.colors.blue}})})]})]}),e.jsx(he,{children:b()})]})};a.div`
background-color: #fff;
