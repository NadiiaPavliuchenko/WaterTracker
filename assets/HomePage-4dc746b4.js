...
`,Jo=P.div`
  display: flex;
  gap: 12px;
`,es=()=>{const{dailyWaterGoal:n}=ge(Ra),[r,t]=k.useState(!1),e=He(),a=()=>{t(!0)},s=()=>{t(!1)},o=(n/1e3).toFixed(1)+" L";return k.useEffect(()=>{e(jr())},[e]),f.jsxs(Uo,{children:[f.jsx(Xo,{children:"My daily norma: "}),f.jsxs(Jo,{children:[f.jsx(Zo,{children:o}),f.jsx(Go,{onClick:a,children:"Edit"})]}),f.jsx(qo,{isModalOpen:r,closeModal:s})]})},ts=P.div`
  display: flex;
  height: 90px;
  flex-direction: column;
  align-items: flex-start;
...
`,iu=({isModalOpen:n,closeModal:r})=>{const[t,e]=k.useState(50),[a,s]=k.useState(new Date),o=He(),i=()=>{e(m=>m+50)},c=()=>{t>=50&&e(m=>m-50)},l=m=>{s(m)},d=m=>{m.preventDefault();const h=a.getTimezoneOffset();o(La({date:a,ml:t,timeZoneOffset:h})),r()},p=m=>{const h=parseInt(m.target.value);e(h)};return f.jsx(f.Fragment,{children:n&&f.jsx(Mn,{onClose:r,children:f.jsxs(su,{children:[f.jsxs("div",{className:"topline",children:[f.jsx("h2",{children:"Add water"}),f.jsx(kn,{className:"close",onClick:r})]}),f.jsx("p",{children:"Choose of water:"}),f.jsxs("form",{onSubmit:d,children:[f.jsxs("label",{children:["Amount of water:",f.jsxs("div",{className:"counter",children:[f.jsx("button",{className:"counterBtn",type:"button",onClick:i,children:f.jsx(Yn,{})}),f.jsxs("span",{className:"waterAmount",children:[t,"ml"]}),f.jsx("button",{className:"counterBtn",type:"button",onClick:c,children:f.jsx(In,{})})]})]}),f.jsxs("label",{children:["Recording time:",f.jsx(_a,{className:"input",selected:a,onChange:m=>l(m),showTimeSelect:!0,showTimeSelectOnly:!0,timeFormat:"HH:mm",dateFormat:"HH:mm"})]}),f.jsxs("label",{children:["Enter the value of the water used:",f.jsx("input",{className:"input",type:"number",value:t,onChange:p})]}),f.jsxs("div",{className:"buttons",children:[f.jsxs("span",{className:"amount",children:[t,"ml"]}),f.jsx("button",{className:"confirm",type:"submit",onClick:d,children:"Save"})]})]})]})})})},cu=()=>{const[n,r]=k.useState(!1),t=ge(Zr),e=He(),a=()=>{r(!0)},s=()=>{r(!1)},o=t>100?100:t;return k.useEffect(()=>{e($a())},[e]),f.jsx(f.Fragment,{children:f.jsxs(ts,{children:[f.jsx("h3",{children:"Today"}),f.jsxs("div",{className:"box",children:[f.jsx(ns,{children:f.jsx("div",{className:"progress-bar-container",children:f.jsxs("div",{className:"progress-bar",children:[f.jsx("div",{className:"progress",style:{width:`${o}%`}}),f.jsx("div",{className:"line-0",children:"|"}),f.jsx("div",{className:"line-50",children:"|"}),f.jsx("div",{className:"line-100",children:"|"}),f.jsx("div",{className:"marker-0",children:"0%"}),f.jsx("div",{className:"marker-50",children:"50%"}),f.jsx("div",{className:"marker-100",children:"100%"}),f.jsx("div",{className:"indicator",style:{left:`${o}%`},children:f.jsx("p",{className:"progress-text",children:t>100?`${t}%`:`${o}%`})})]})})}),f.jsxs(rs,{onClick:a,children:[f.jsx(as,{width:"20px",height:"20px",children:f.jsx("use",{xlinkHref:`${qe}#plus-circle`})})," ",f.jsx("p",{children:"Add Water"})]})]}),n&&f.jsx(iu,{isModalOpen:n,closeModal:s})]})})},lu=P.div`
  *::-webkit-scrollbar {
    width: 4px;
  }
...
`,du=({isModalOpen:n,closeModal:r})=>{const[t,e]=k.useState(50),[a,s]=k.useState(""),{id:o,ml:i,time:c}=ge(Io),l=He(),d=()=>{e(w=>w+50)},p=()=>{t>=50&&e(w=>w-50)},m=w=>{s(w)},h=w=>{w.preventDefault();const v={time:a,ml:t};console.log(v),l(Fa({id:o,data:v}))},y=w=>{const v=parseInt(w.target.value);e(v)};return f.jsx(f.Fragment,{children:n&&f.jsx(Mn,{onClose:r,children:f.jsxs(uu,{children:[f.jsxs("div",{className:"topline",children:[f.jsx("h2",{children:"Edit the entered amount of water"}),f.jsx(kn,{className:"close",onClick:r})]}),f.jsxs("span",{className:"amount",children:[i,"ml"]}),c,f.jsx("p",{children:"Correct entered data:"}),f.jsxs("form",{onSubmit:h,children:[f.jsxs("label",{children:["Amount of water:",f.jsxs("div",{className:"counter",children:[f.jsx("button",{className:"counterBtn",type:"button",onClick:d,children:f.jsx(Yn,{})}),f.jsxs("span",{className:"waterAmount",children:[t,"ml"]}),f.jsx("button",{className:"counterBtn",type:"button",onClick:p,children:f.jsx(In,{})})]})]}),f.jsxs("label",{children:["Recording time:",f.jsx(_a,{className:"input",selected:a,onChange:w=>m(w),showTimeSelect:!0,showTimeSelectOnly:!0,timeFormat:"HH:mm",dateFormat:"HH:mm"})]}),f.jsxs("label",{children:["Enter the value of the water used:",f.jsx("input",{className:"input",type:"number",value:t,onChange:y})]}),f.jsxs("div",{className:"buttons",children:[f.jsxs("span",{className:"amount",children:[t,"ml"]}),f.jsx("button",{className:"confirm",type:"submit",onClick:h,children:"Save"})]})]})]})})})},pu=()=>{const[n,r]=k.useState(!1);ge(Ro);const t=He(),e=[{id:1,volume:"200 ml",date:14.02},{id:2,volume:"200 ml",date:14.45},{id:3,volume:"150 ml",date:16.12},{id:4,volume:"50 ml",date:18.01},{id:5,volume:"300 ml",date:19.03},{id:6,volume:"100 ml",date:21.05},{id:7,volume:"5 ml",date:22.05}],a=i=>{r(!0)},s=()=>{r(!1)},o=i=>{console.dir(i.target.closest("LI").id),t(ja(i.target.closest("LI").id))};return f.jsxs(f.Fragment,{children:[f.jsxs(lu,{children:[f.jsx("h3",{className:"title",children:"Today"}),f.jsx("ul",{className:"waterList",children:e.length>0?e.map(i=>f.jsxs("li",{className:"waterItem",id:i.id,children:[f.jsxs("div",{className:"volumeAdnDate",children:[f.jsx("svg",{className:"waterGlass",width:"26",height:"26",stroke:"#9ebbff",fill:"none",children:f.jsx("use",{href:qe+"#water-glass"})}),f.jsx("span",{className:"waterVolume",children:i.volume}),f.jsx("span",{className:"waterTime",children:i.date})]}),f.jsxs("div",{className:"editDelete",children:[f.jsx("svg",{onClick:a,width:"16",height:"13",stroke:"#9ebbff",fill:"none",children:f.jsx("use",{href:qe+"#pencil-square"})}),f.jsx("svg",{onClick:o,width:"16",height:"16",stroke:"#ef5050",fill:"none",children:f.jsx("use",{href:qe+"#trash"})})]})]},i.id)):f.jsx("p",{children:"You don't have records on this day"})}),f.jsx("h3",{className:"addWater",children:"+ Add water"})]}),n&&f.jsx(du,{isModalOpen:n,closeModal:s})]})};var Bn={},fu=Bt;Object.defineProperty(Bn,"__esModule",{value:!0});var Sa=Bn.default=void 0,hu=fu(Ht()),mu=f;Sa=Bn.default=(0,hu.default)((0,mu.jsx)("path",{d:"M6.23 20.23 8 22l10-10L8 2 6.23 3.77 14.46 12z"}),"ArrowForwardIos");var Qn={},gu=Bt;Object.defineProperty(Qn,"__esModule",{value:!0});var Pa=Qn.default=void 0,yu=gu(Ht()),wu=f;Pa=Qn.default=(0,yu.default)((0,wu.jsx)("path",{d:"M11.67 3.87 9.9 2.1 0 12l9.9 9.9 1.77-1.77L3.54 12z"}),"ArrowBackIos");const bu=P.div`
  display: flex;
  flex-direction: column;
  gap: 16px;
  width: 280px;
...
`,vu=({calendarRef:n,refData:r,day:t,month:e,dailyWaterGoal:a,consumedWaterPercentage:s,consumedTimes:o})=>{const i=`${t}, ${e}`,c=r==null?void 0:r.current.getBoundingClientRect().left,l=n==null?void 0:n.current.getBoundingClientRect().left;let d=!0;const p=c-l;return p<200&&(d=!1),f.jsx(bu,{$delta:d,$deltaNum:p,children:f.jsxs(f.Fragment,{children:[f.jsx("h3",{children:i}),f.jsxs("p",{children:["Daily norma: ",f.jsxs("span",{children:[a/1e3," L"]})]}),f.jsxs("p",{children:["Fulfillment of the daily norm: ",f.jsxs("span",{children:[s,"%"]})]}),f.jsxs("p",{children:["How many servings of water: ",f.jsx("span",{children:o})]})]})})},xu=P.div`
  display: flex;
  flex-direction: column;
`,Du=P.div`
  display: flex;
...
`;const ln={colors:{white:"#FFFFFF",black:"#2F2F2F",blue:"#407BFF",red:"#EF5050",orange:"#FF9D43",grey:"#ECF2FF",violet:"#9EBBFF",violet_light:"#D7E3FF"},animation:{duration:"0.3s",cubicBezier:"cubic-bezier(0.5, 0, 0.2, 1)"}},Wu=()=>{const[n,r]=k.useState(new Date),t=He(),e=k.useRef(null),a=ge(Zr),s=ge(Yo),o=ge($o);k.useEffect(()=>{const y=n.getTimezoneOffset(),w=new Date(n.getFullYear(),n.getMonth(),1);w.setMinutes(w.getMinutes()-y);const v=new Date(n.getFullYear(),n.getMonth()+1,0);v.setMinutes(v.getMinutes()-y);const x=w.toISOString().split("T")[0],b=v.toISOString().split("T")[0],D={startDate:x,endDate:b};t(Wa(D)),console.log(D)},[t,n,a]);const i=()=>{const y=new Date(n.getFullYear(),n.getMonth()+1,1);r(y)},c=()=>{const y=new Date(n.getFullYear(),n.getMonth()-1,1);r(y)},l=()=>{const y=new Date;return n.getMonth()===y.getMonth()&&n.getFullYear()===y.getFullYear()},d=()=>new Date(n.getFullYear(),n.getMonth()+1,0).getDate(),p=()=>{const y=new Date(n).getMonth(),w=new Date(n).toLocaleString("en-US",{month:"long"});return{monthNumber:y,monthName:w}},m=()=>new Date(n).getFullYear(),h=()=>{const y=d(),w=p(),v=m();return Array.from({length:y},(x,b)=>{if(!s)return;const D=b+1,E=s.find(({entryDate:N})=>D===new Date(N).getDate()),_=E?E.consumedWaterPercentage:0,T=E?E.dailyWaterGoal:0,C=E?E.consumedTimes:0;return f.jsx(Nu,{day:D,month:w,year:v,dailyWaterGoal:T,consumedWaterPercentage:_,consumedTimes:C},D)})};return f.jsxs(xu,{className:"calendar",ref:e,children:[f.jsxs(Du,{children:[f.jsx(ku,{children:"Month"}),o&&f.jsx(Fu,{height:"60",width:"60",radius:"9",color:ln.colors.blue,ariaLabel:"three-dots-loading",wrapperStyle:{height:"30px",width:"40px",display:"flex",alignItems:"center",justifyContent:"center"},wrapperClassName:"",visible:!0}),f.jsxs(Cu,{children:[f.jsx($r,{"aria-label":"Previous month",onClick:c,children:f.jsx(Pa,{sx:{color:ln.colors.blue}})}),f.jsx(_u,{children:`${new Intl.DateTimeFormat("en-US",{month:"long"}).format(n)}, ${n.getFullYear()}`}),f.jsx($r,{"aria-label":"Next month",onClick:i,disabled:l(),children:f.jsx(Sa,{sx:{color:ln.colors.blue}})})]})]}),f.jsx(Pu,{children:h()})]})},Au=P.div`
...
`,Vu=()=>f.jsx(Au,{children:f.jsx(Aa,{children:f.jsxs(Hu,{children:[f.jsxs(Bu,{children:[f.jsx(es,{}),f.jsx(cu,{})]}),f.jsxs(Qu,{children:[f.jsx(pu,{}),f.jsx(Wu,{})]})]})})});export{Vu as default};
