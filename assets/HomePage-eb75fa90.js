...
`,ts="/WaterTrackerFrontend/assets/bottle_desk_1x-8726a8d2.png",ns=()=>{const{dailyWaterGoal:n}=ge(Ra),[r,t]=k.useState(!1),e=He(),a=()=>{t(!0)},s=()=>{t(!1)},o=(n/1e3).toFixed(1)+" L";return k.useEffect(()=>{e(jr())},[e]),f.jsxs(Uo,{children:[f.jsx(Xo,{children:"My daily norma: "}),f.jsxs(Jo,{children:[f.jsx(Zo,{children:o}),f.jsx(Go,{onClick:a,children:"Edit"})]}),f.jsx(qo,{isModalOpen:r,closeModal:s}),f.jsx(es,{src:ts,alt:"Bottle"})]})},rs=P.div`
  display: flex;
  height: 90px;
  flex-direction: column;
  align-items: flex-start;
