...
`,To=({isModalOpen:n,closeModal:r})=>{const[t,e]=k.useState(50),[o,s]=k.useState(new Date),a=Be(),i=()=>{e(m=>m+50)},c=()=>{t>=50&&e(m=>m-50)},l=m=>{s(m)},d=m=>{m.preventDefault();const h=o.getTimezoneOffset();a(jo({date:o,ml:t,timeZoneOffset:h})),r()},f=m=>{const h=parseInt(m.target.value);e(h)};return p.jsx(p.Fragment,{children:n&&p.jsx(Bt,{onClose:r,children:p.jsxs(hu,{children:[p.jsxs("div",{className:"topline",children:[p.jsx("h2",{children:"Add water"}),p.jsx(Ht,{className:"close",onClick:r})]}),p.jsx("p",{children:"Choose of water:"}),p.jsxs("form",{onSubmit:d,children:[p.jsxs("label",{children:["Amount of water:",p.jsxs("div",{className:"counter",children:[p.jsx("button",{className:"counterBtn",type:"button",onClick:i,children:p.jsx(Yn,{})}),p.jsxs("span",{className:"waterAmount",children:[t,"ml"]}),p.jsx("button",{className:"counterBtn",type:"button",onClick:c,children:p.jsx(In,{})})]})]}),p.jsxs("label",{children:["Recording time:",p.jsx(Po,{className:"input",selected:o,onChange:m=>l(m),showTimeSelect:!0,showTimeSelectOnly:!0,timeFormat:"HH:mm",dateFormat:"HH:mm"})]}),p.jsxs("label",{children:["Enter the value of the water used:",p.jsx("input",{className:"input",type:"number",value:t,onChange:f})]}),p.jsxs("div",{className:"buttons",children:[p.jsxs("span",{className:"amount",children:[t,"ml"]}),p.jsx("button",{className:"confirm",type:"submit",onClick:d,children:"Save"})]})]})]})})})},mu=()=>{const[n,r]=k.useState(!1),t=ve(La),e=Be(),o=()=>{r(!0)},s=()=>{r(!1)},a=t>100?100:t;return k.useEffect(()=>{e(Wo())},[e]),p.jsx(p.Fragment,{children:p.jsxs(ls,{children:[p.jsx("h3",{children:"Today"}),p.jsxs("div",{className:"box",children:[p.jsx(us,{children:p.jsx("div",{className:"progress-bar-container",children:p.jsxs("div",{className:"progress-bar",children:[p.jsx("div",{className:"progress",style:{width:`${a}%`}}),p.jsx("div",{className:"line-0",children:"|"}),p.jsx("div",{className:"line-50",children:"|"}),p.jsx("div",{className:"line-100",children:"|"}),p.jsx("div",{className:"marker-0",children:"0%"}),p.jsx("div",{className:"marker-50",children:"50%"}),p.jsx("div",{className:"marker-100",children:"100%"}),p.jsx("div",{className:"indicator",style:{left:`${a}%`},children:p.jsx("p",{className:"progress-text",children:t>100?`${t}%`:`${a}%`})})]})})}),p.jsxs(ds,{onClick:o,children:[p.jsx(ps,{width:"20px",height:"20px",children:p.jsx("use",{xlinkHref:`${Le}#plus-circle`})})," ",p.jsx("p",{children:"Add Water"})]})]}),n&&p.jsx(To,{isModalOpen:n,closeModal:s})]})})},gu=P.div`
  *::-webkit-scrollbar {
    width: 4px;
  }
