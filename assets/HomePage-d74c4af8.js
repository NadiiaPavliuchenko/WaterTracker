...
`,ct=P.p`
  ...
  line-height: 1.28571;
  color: ${({theme:n})=>n.color.red};
`,Ia=n=>n.water.month,$a=n=>n.water.dayInfo,Jr=n=>{var r;return(r=n.water.dayInfo)==null?void 0:r.consumedWaterPercentage},La=n=>{var r;return(r=n.water.dayInfo)==null?void 0:r.dailyWaterGoal},Fa=n=>n.water.dayDataLoading,ja=({closeModal:n})=>{const t=(ve(La)/1e3).toFixed(1),[e,o]=k.useState(""),[s,a]=k.useState(!0),i=15,c=f=>{const{value:m}=f.target,h=/^(\d+([.,]\d{0,1})?)?$/;var g=m;m.match(/^[.,]/)?g="0"+m:g=m.replace(/^0+([^.])/,"$1"),a(g===""||parseFloat(g.replace(",","."))<=i),h.test(g)&&o(g)},l=He(),d=async f=>{if(f.preventDefault(),!s||e<=0)return;const m=f.target.elements.dailyNorm.value*1e3;try{const{payload:h}=await l(Ro(m));h.user&&(l(Wr()),n())}catch(h){console.log("🚀 ~ error:",h)}};return p.jsxs("form",{onSubmit:d,children:[p.jsxs(Ya,{children:["Write down how much water you will drink:",p.jsx(fn,{className:!s&&e<=0?"error":"",type:"number",name:"dailyNorm",value:e,onChange:c,placeholder:t}),!s&&p.jsx(ct,{children:`The water rate cannot exceed ${i} liters`}),e<0&&p.jsx(ct,{children:"The water rate cannot be negative"}),parseFloat(e)===0&&p.jsx(ct,{children:"The water rate cannot be 0"})]}),p.jsx(Ra,{className:"confirm",type:"submit",children:"Save"})]})},Wa=()=>{const n=ve(Io),[r,t]=k.useState(n),[e,o]=k.useState(""),[s,a]=k.useState(""),[i,c]=k.useState(!0),[l,d]=k.useState(!0),f=ve($o)?"dark":"light",h=`radio-${r==="woman"?"active":"inactive"}-${f}`,y=`radio-${r==="man"?"active":"inactive"}-${f}`,x=300,v=12,b=_=>{const{name:O,value:C}=_.target,N=/^(\d+([.,]\d{0,1})?)?$/;var Y=C;switch(O){case"gender":t(C);break;case"weight":C.match(/^[.,]/)?Y="0"+C:Y=C.replace(/^0+([^.])/,"$1"),c(Y===""||parseFloat(Y.replace(",","."))<=x),N.test(Y)&&o(Y);break;case"activeHours":C.match(/^[.,]/)?Y="0"+C:Y=C.replace(/^0+([^.])/,"$1"),d(Y===""||parseFloat(Y.replace(",","."))<=v),N.test(Y)&&a(Y);break}},D=r==="woman"?e*.03+s*.4:e*.04+s*.6,T=Math.round(D*10)/10;return p.jsx("div",{children:p.jsxs("form",{action:"",children:[p.jsx(Pa,{children:"Calculate your rate:"}),p.jsxs(Ta,{children:[p.jsxs(Zn,{children:[p.jsx(Jn,{id:"woman",type:"radio",name:"gender",value:"woman",checked:r==="woman",onChange:b}),p.jsxs(er,{htmlFor:"woman",children:[p.jsx(tr,{children:p.jsx(nr,{children:p.jsx("use",{href:`${qe}#${h}`})})}),"For woman"]})]}),p.jsxs(Zn,{children:[p.jsx(Jn,{id:"man",type:"radio",name:"gender",value:"man",checked:r==="man",onChange:b}),p.jsxs(er,{htmlFor:"man",children:[p.jsx(tr,{children:p.jsx(nr,{children:p.jsx("use",{href:`${qe}#${y}`})})}),"For man"]})]})]}),p.jsxs(rr,{children:["Your weight in kilograms:",p.jsx(fn,{className:i?"":"error",type:"number",name:"weight",value:e,onChange:b,placeholder:"0"}),!i&&p.jsx(ct,{children:`Weight cannot exceed ${x} kg`})]}),p.jsxs(rr,{children:["The time of active participation in sports or other activities with a high physical. load in hours:",p.jsx(fn,{className:l?"":"error",type:"number",name:"activeHours",value:s,onChange:b,placeholder:"0"}),!l&&p.jsx(ct,{children:`Active hours cannot exceed ${v} hours`})]}),p.jsxs(Na,{children:[p.jsxs(Oa,{children:["The required amount of water in liters per day:"," "]}),i&&l&&p.jsxs(Ea,{children:[T," L"]})]})]})})},Aa=P.div`
  display: flex;
  flex-direction: column;
  gap: 24px;
...
`,sr="/WaterTrackerFrontend/assets/bottle_mob_1x-a2794dc7.png",rs="/WaterTrackerFrontend/assets/bottle_mob_2x-4351fbbd.png",os="/WaterTrackerFrontend/assets/bottle_tab-881bc7f1.png",as="/WaterTrackerFrontend/assets/bottle_tab_2x-f93ca187.png",ss="/WaterTrackerFrontend/assets/bottle_desk-1f4873df.png",is="/WaterTrackerFrontend/assets/bottle_desk_2x-dc99a824.png",cs=()=>{const{dailyWaterGoal:n}=ve(Lo),[r,t]=k.useState(!1),e=He(),o=()=>{t(!0)},s=()=>{t(!1)},a=(n/1e3).toFixed(1)+" L";return k.useEffect(()=>{e(Wr())},[e]),p.jsxs(Xa,{children:[p.jsxs(Ga,{children:[p.jsx(Za,{children:"My daily norma: "}),p.jsxs(ts,{children:[p.jsx(es,{children:a}),p.jsx(Ja,{onClick:o,children:"Edit"})]}),p.jsx(Ua,{isModalOpen:r,closeModal:s})]}),p.jsxs("picture",{className:"bottle",children:[p.jsx("source",{srcSet:`${ss} 1x, ${is} 2x`,media:"(min-width: 1440px)",type:"image/png"}),p.jsx("source",{srcSet:`${os} 1x, ${as} 2x`,media:"(min-width: 768px)",type:"image/png"}),p.jsx("source",{srcSet:`${sr} 1x, ${rs} 2x`,media:"(min-width: 320px)",type:"image/png"}),p.jsx(ns,{className:"bottle",alt:"bottle of water",src:sr})]})]})},ls=P.div`
  display: flex;
  height: 90px;
  flex-direction: column;
...
`,To=({isModalOpen:n,closeModal:r})=>{const[t,e]=k.useState(50),[o,s]=k.useState(new Date),a=He(),i=()=>{e(m=>m+50)},c=()=>{t>=50&&e(m=>m-50)},l=m=>{s(m)},d=m=>{m.preventDefault();const h=o.getTimezoneOffset();a(jo({date:o,ml:t,timeZoneOffset:h})),r()},f=m=>{const h=parseInt(m.target.value);e(h)};return p.jsx(p.Fragment,{children:n&&p.jsx(Bt,{onClose:r,children:p.jsxs(hu,{children:[p.jsxs("div",{className:"topline",children:[p.jsx("h2",{children:"Add water"}),p.jsx(Ht,{className:"close",onClick:r})]}),p.jsx("p",{children:"Choose of water:"}),p.jsxs("form",{onSubmit:d,children:[p.jsxs("label",{children:["Amount of water:",p.jsxs("div",{className:"counter",children:[p.jsx("button",{className:"counterBtn",type:"button",onClick:i,children:p.jsx(Yn,{})}),p.jsxs("span",{className:"waterAmount",children:[t,"ml"]}),p.jsx("button",{className:"counterBtn",type:"button",onClick:c,children:p.jsx(In,{})})]})]}),p.jsxs("label",{children:["Recording time:",p.jsx(Po,{className:"input",selected:o,onChange:m=>l(m),showTimeSelect:!0,showTimeSelectOnly:!0,timeFormat:"HH:mm",dateFormat:"HH:mm"})]}),p.jsxs("label",{children:["Enter the value of the water used:",p.jsx("input",{className:"input",type:"number",value:t,onChange:f})]}),p.jsxs("div",{className:"buttons",children:[p.jsxs("span",{className:"amount",children:[t,"ml"]}),p.jsx("button",{className:"confirm",type:"submit",onClick:d,children:"Save"})]})]})]})})})},mu=()=>{const[n,r]=k.useState(!1),t=ve(Jr),e=He(),o=()=>{r(!0)},s=()=>{r(!1)},a=t>100?100:t;return k.useEffect(()=>{e(Wo())},[e]),p.jsx(p.Fragment,{children:p.jsxs(ls,{children:[p.jsx("h3",{children:"Today"}),p.jsxs("div",{className:"box",children:[p.jsx(us,{children:p.jsx("div",{className:"progress-bar-container",children:p.jsxs("div",{className:"progress-bar",children:[p.jsx("div",{className:"progress",style:{width:`${a}%`}}),p.jsx("div",{className:"line-0",children:"|"}),p.jsx("div",{className:"line-50",children:"|"}),p.jsx("div",{className:"line-100",children:"|"}),p.jsx("div",{className:"marker-0",children:"0%"}),p.jsx("div",{className:"marker-50",children:"50%"}),p.jsx("div",{className:"marker-100",children:"100%"}),p.jsx("div",{className:"indicator",style:{left:`${a}%`},children:p.jsx("p",{className:"progress-text",children:t>100?`${t}%`:`${a}%`})})]})})}),p.jsxs(ds,{onClick:o,children:[p.jsx(ps,{width:"20px",height:"20px",children:p.jsx("use",{xlinkHref:`${qe}#plus-circle`})})," ",p.jsx("p",{children:"Add Water"})]})]}),n&&p.jsx(To,{isModalOpen:n,closeModal:s})]})})},gu=P.div`
  *::-webkit-scrollbar {
    width: 4px;
  }
...
`,yu=n=>{console.log("🚀 ~ isoDateString:",n);const r=new Date(n),t=r.getTimezoneOffset();console.log("🚀 ~ timeZoneOffset:",t);const e=Math.floor(Math.abs(t)/60);console.log("🚀 ~ offsetHours:",e);const o=Math.abs(t)%60;console.log("🚀 ~ offsetMinutes:",o);const s=e.toString().padStart(2,"0");console.log("🚀 ~ offsetHoursFormatted:",s);const a=o.toString().padStart(2,"0");console.log("🚀 ~ offsetMinutesFormatted:",a);const i=`${t>=0?"-":"+"}${s}:${a}`;console.log("🚀 ~ timeZoneOffsetString:",i);const c=new Date(r.getFullYear(),r.getMonth(),r.getDate(),r.getHours(),r.getMinutes(),r.getSeconds());console.log("🚀 ~ dateWithoutMilliseconds:",c);const l=`${c.toISOString().split(".")[0]}${i}`;return console.log("🚀 ~ isoDateWithTimeZone:",l),l},bu=({isModalOpen:n,closeModal:r,currentIntakes:t})=>{const[e,o]=k.useState(t.ml);console.log("🚀 ~ waterAmount:",e);const s=yu(t.time),[a,i]=k.useState(new Date(s));console.log("🚀 ~ selectedTime:",a);const c=He(),l=()=>{o(g=>g+50)},d=()=>{e>=50&&o(g=>g-50)},f=g=>{i(g)},m=g=>{g.preventDefault();const y=new Date(a).getTimezoneOffset(),x={date:a,ml:e,timeZoneOffset:y};c(Ao({id:t.id,body:x}))},h=g=>{const y=parseInt(g.target.value);o(y)};return p.jsx(p.Fragment,{children:n&&p.jsx(Bt,{onClose:r,children:p.jsxs(wu,{children:[p.jsxs("div",{className:"topline",children:[p.jsx("h2",{children:"Edit the entered amount of water"}),p.jsx(Ht,{className:"close",onClick:r})]}),p.jsxs("p",{children:[p.jsxs("span",{className:"amount",children:[t.ml,"ml"]}),t.time.slice(11,16)]}),p.jsx("p",{children:"Correct entered data:"}),p.jsxs("form",{onSubmit:m,children:[p.jsxs("label",{children:["Amount of water:",p.jsxs("div",{className:"counter",children:[p.jsx("button",{className:"counterBtn",type:"button",onClick:l,children:p.jsx(Yn,{})}),p.jsxs("span",{className:"waterAmount",children:[e,"ml"]}),p.jsx("button",{className:"counterBtn",type:"button",onClick:d,children:p.jsx(In,{})})]})]}),p.jsxs("label",{children:["Recording time:",p.jsx(Po,{className:"input",selected:a,onChange:g=>f(g),showTimeSelect:!0,showTimeSelectOnly:!0,timeFormat:"HH:mm",dateFormat:"HH:mm"})]}),p.jsxs("label",{children:["Enter the value of the water used:",p.jsx("input",{className:"input",type:"number",value:e,onChange:h})]}),p.jsxs("div",{className:"buttons",children:[p.jsxs("span",{className:"amount",children:[e,"ml"]}),p.jsx("button",{className:"confirm",type:"submit",onClick:m,children:"Save"})]})]})]})})})},xu=P.div`
  display: block;
  position: absolute;
  top: 50%;
  left: 50%;
...
`,Ou=({calendarRef:n,refData:r,day:t,month:e,dailyWaterGoal:o,consumedWaterPercentage:s,consumedTimes:a})=>{const i=`${t}, ${e}`,c=r==null?void 0:r.current.getBoundingClientRect().left,l=n==null?void 0:n.current.getBoundingClientRect().left;let d=!0;const f=c-l;return f<200&&(d=!1),p.jsx(Nu,{$delta:d,$deltaNum:f,children:p.jsxs(p.Fragment,{children:[p.jsx("h3",{children:i}),p.jsxs("p",{children:["Daily norma: ",p.jsxs("span",{children:[o/1e3," L"]})]}),p.jsxs("p",{children:["Fulfillment of the daily norm: ",p.jsxs("span",{children:[s,"%"]})]}),p.jsxs("p",{children:["How many servings of water: ",p.jsx("span",{children:a})]})]})})},Eu=P.div`
  display: flex;
  flex-direction: column;
`,Yu=P.div`
  display: flex;
...
`,Wu=P.div`
  ...
  align-items: center;
  position: relative;
`,Au=({calendarRef:n,day:r,month:t,year:e,dailyWaterGoal:o,consumedWaterPercentage:s,consumedTimes:a})=>{const i=new Date(e,t.monthNumber,r),c=new Date>=i,[l,d]=k.useState(null),f=k.useRef(null),m=g=>{f.current&&!f.current.contains(g.target)&&d(null)};k.useEffect(()=>(document.addEventListener("click",m),()=>{document.removeEventListener("click",m)}),[]);const h=()=>{d(g=>g===r?null:r)};return p.jsxs(Wu,{children:[p.jsx("div",{children:l===r&&p.jsx(Ou,{calendarRef:n,refData:f,waterDay:s,day:r,month:t.monthName,dailyWaterGoal:o,consumedWaterPercentage:s,consumedTimes:a},r)}),p.jsx(Iu,{ref:f,onClick:()=>h(),$isOutlineVisible:s<100&&c,children:r}),p.jsx(Fu,{children:`${s}%`})]},r)},Hu="#4fa94d",Bu={"aria-busy":!0,role:"progressbar"},Qu=P.div`
  display: ${n=>n.$visible?"flex":"none"};
`,Ku="http://www.w3.org/2000/svg",ue=242.776657104492,zu=1.6,Vu=Cn`
12.5% {
...
`;P.path`
  ...
  stroke-dashoffset: 0;
  animation: ${Vu} ${zu}s linear infinite;
`;const qu=Cn`
to {
   transform: rotate(360deg);
 }
`;P.svg`
  animation: ${qu} 0.75s steps(12, end) infinite;
...
`;const Uu=({height:n=80,width:r=80,radius:t=9,color:e=Hu,ariaLabel:o="three-dots-loading",wrapperStyle:s,wrapperClass:a,visible:i=!0})=>p.jsx(Qu,{style:s,$visible:i,className:a,"data-testid":"three-dots-loading","aria-label":o,...Bu,children:p.jsxs("svg",{width:r,height:n,viewBox:"0 0 120 30",xmlns:Ku,fill:e,"data-testid":"three-dots-svg",children:[p.jsxs("circle",{cx:"15",cy:"15",r:Number(t)+6,children:[p.jsx("animate",{attributeName:"r",from:"15",to:"15",begin:"0s",dur:"0.8s",values:"15;9;15",calcMode:"linear",repeatCount:"indefinite"}),p.jsx("animate",{attributeName:"fill-opacity",from:"1",to:"1",begin:"0s",dur:"0.8s",values:"1;.5;1",calcMode:"linear",repeatCount:"indefinite"})]}),p.jsxs("circle",{cx:"60",cy:"15",r:t,attributeName:"fill-opacity",from:"1",to:"0.3",children:[p.jsx("animate",{attributeName:"r",from:"9",to:"9",begin:"0s",dur:"0.8s",values:"9;15;9",calcMode:"linear",repeatCount:"indefinite"}),p.jsx("animate",{attributeName:"fill-opacity",from:"0.5",to:"0.5",begin:"0s",dur:"0.8s",values:".5;1;.5",calcMode:"linear",repeatCount:"indefinite"})]}),p.jsxs("circle",{cx:"105",cy:"15",r:Number(t)+6,children:[p.jsx("animate",{attributeName:"r",from:"15",to:"15",begin:"0s",dur:"0.8s",values:"15;9;15",calcMode:"linear",repeatCount:"indefinite"}),p.jsx("animate",{attributeName:"fill-opacity",from:"1",to:"1",begin:"0s",dur:"0.8s",values:"1;.5;1",calcMode:"linear",repeatCount:"indefinite"})]})]})}),Xu=Cn`
to {
   stroke-dashoffset: 136;
 }
`;P.polygon`
  stroke-dasharray: 17;
  animation: ${Xu} 2.5s cubic-bezier(0.35, 0.04, 0.63, 0.95) infinite;
`;P.svg`
  transform-origin: 50% 65%;
`;const dn={colors:{white:"#FFFFFF",black:"#2F2F2F",blue:"#407BFF",red:"#EF5050",orange:"#FF9D43",grey:"#ECF2FF",violet:"#9EBBFF",violet_light:"#D7E3FF"},animation:{duration:"0.3s",cubicBezier:"cubic-bezier(0.5, 0, 0.2, 1)"}},Gu=()=>{const[n,r]=k.useState(new Date),t=He(),e=k.useRef(null),o=ve(Jr),s=ve(Ia),a=ve(Fa);k.useEffect(()=>{const g=n.getTimezoneOffset(),y=new Date(n.getFullYear(),n.getMonth(),1);y.setMinutes(y.getMinutes()-g);const x=new Date(n.getFullYear(),n.getMonth()+1,0);x.setMinutes(x.getMinutes()-g);const v=y.toISOString().split("T")[0],b=x.toISOString().split("T")[0],D={startDate:v,endDate:b};t(Bo(D)),console.log(D)},[t,n,o]);const i=()=>{const g=new Date(n.getFullYear(),n.getMonth()+1,1);r(g)},c=()=>{const g=new Date(n.getFullYear(),n.getMonth()-1,1);r(g)},l=()=>{const g=new Date;return n.getMonth()===g.getMonth()&&n.getFullYear()===g.getFullYear()},d=()=>new Date(n.getFullYear(),n.getMonth()+1,0).getDate(),f=()=>{const g=new Date(n).getMonth(),y=new Date(n).toLocaleString("en-US",{month:"long"});return{monthNumber:g,monthName:y}},m=()=>new Date(n).getFullYear(),h=()=>{const g=d(),y=f(),x=m();return Array.from({length:g},(v,b)=>{if(!s)return;const D=b+1,T=s.find(({entryDate:N})=>D===new Date(N).getDate()),_=T?T.consumedWaterPercentage:0,O=T?T.dailyWaterGoal:0,C=T?T.consumedTimes:0;return p.jsx(Au,{day:D,month:y,year:x,dailyWaterGoal:O,consumedWaterPercentage:_,consumedTimes:C},D)})};return p.jsxs(Eu,{className:"calendar",ref:e,children:[p.jsxs(Yu,{children:[p.jsx(Ru,{children:"Month"}),a&&p.jsx(Uu,{height:"60",width:"60",radius:"9",color:dn.colors.blue,ariaLabel:"three-dots-loading",wrapperStyle:{height:"30px",width:"40px",display:"flex",alignItems:"center",justifyContent:"center"},wrapperClassName:"",visible:!0}),p.jsxs($u,{children:[p.jsx(Fr,{"aria-label":"Previous month",onClick:c,children:p.jsx(Oo,{sx:{color:dn.colors.blue}})}),p.jsx(Lu,{children:`${new Intl.DateTimeFormat("en-US",{month:"long"}).format(n)}, ${n.getFullYear()}`}),p.jsx(Fr,{"aria-label":"Next month",onClick:i,disabled:l(),children:p.jsx(No,{sx:{color:dn.colors.blue}})})]})]}),p.jsx(ju,{children:h()})]})},Zu=P.div`
...
`,ad=()=>p.jsx(Zu,{children:p.jsx(Qo,{children:p.jsxs(Ju,{children:[p.jsxs(ed,{children:[p.jsx(cs,{}),p.jsx(mu,{})]}),p.jsx(td,{children:p.jsxs(nd,{children:[p.jsx(ku,{}),p.jsx(Gu,{})]})})]})})});export{ad as default};
