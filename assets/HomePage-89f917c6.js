import{r as u,u as F,j as e,e as R,a as y,g as _,b as a,M as I,d as T,c as B,f as N,i as D,h as w,k as E,W}from"./index-7d12c828.js";import{b as O}from"./bg_img_bubbles-c11f2eb9.js";const Y=({closeModal:n})=>{const i=30 .toFixed(1),[s,l]=u.useState(""),r=h=>{const{value:p}=h.target,x=/^(\d+([.,]\d{0,1})?)?$/;var b=p;p.match(/^[.,]/)?b="0"+p:b=p.replace(/^0+([^.])/,"$1"),x.test(b)&&l(b)},c=F(),d=async h=>{h.preventDefault();const p=h.target.elements.dailyNorm.value*1e3;try{const{payload:x}=await c(R(p));x.user&&n()}catch(x){console.log("🚀 ~ error:",x)}};return e.jsxs("form",{onSubmit:d,children:[e.jsxs("label",{children:["Write down how much water you will drink:",e.jsx("input",{type:"number",name:"dailyNorm",value:s,onChange:r,placeholder:i})]}),e.jsx("button",{className:"confirm",type:"submit",children:"Save"})]})},A=()=>{const n=y(_),[t,i]=u.useState(n),[s,l]=u.useState(""),[r,c]=u.useState(""),d=x=>{const{name:b,value:o}=x.target,j=/^(\d+([.,]\d{0,1})?)?$/;var g=o;switch(b){case"gender":i(o);break;case"weight":o.match(/^[.,]/)?g="0"+o:g=o.replace(/^0+([^.])/,"$1"),j.test(g)&&l(g);break;case"activeHours":o.match(/^[.,]/)?g="0"+o:g=o.replace(/^0+([^.])/,"$1"),j.test(g)&&c(g);break}},h=t==="woman"?s*.03+r*.4:s*.04+r*.6,p=Math.round(h*10)/10;return e.jsx("div",{children:e.jsxs("form",{action:"",children:[e.jsx("h3",{children:"Calculate your rate:"}),e.jsxs("label",{children:["Gender",e.jsxs("label",{children:["For woman",e.jsx("input",{type:"radio",name:"gender",value:"woman",checked:t==="woman",onChange:d})]}),e.jsxs("label",{children:["For man",e.jsx("input",{type:"radio",name:"gender",value:"man",checked:t==="man",onChange:d})]})]}),e.jsxs("label",{htmlFor:"",children:["Your weight in kilograms:",e.jsx("input",{type:"number",name:"weight",value:s,onChange:d,placeholder:"0"})]}),e.jsxs("label",{htmlFor:"",children:["The time of active participation in sports or other activities with a high physical. load in hours:",e.jsx("input",{type:"number",name:"activeHours",value:r,onChange:d,placeholder:"0"})]}),e.jsxs("p",{children:["The required amount of water in liters per day:"," ",e.jsxs("span",{children:[p," L"]})]})]})})},H=a.div`
  display: flex;
