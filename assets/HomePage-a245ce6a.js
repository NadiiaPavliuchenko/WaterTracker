...
`,es=P.div`
  display: flex;
  gap: 12px;
`,ts="/WaterTrackerFrontend/assets/bottle_desk_1x-8726a8d2.png",ns=()=>{const{dailyWaterGoal:n}=ge(Ra),[r,t]=k.useState(!1),e=He(),a=()=>{t(!0)},s=()=>{t(!1)},o=(n/1e3).toFixed(1)+" L";return k.useEffect(()=>{e(jr())},[e]),f.jsxs(Xo,{children:[f.jsx(Go,{children:"My daily norma: "}),f.jsxs(es,{children:[f.jsx(Jo,{children:o}),f.jsx(Zo,{onClick:a,children:"Edit"})]}),f.jsx(qo,{isModalOpen:r,closeModal:s}),f.jsx(Uo,{img:!0,src:ts,alt:"Bottle"})]})},rs=P.div`
  display: flex;
  height: 90px;
  flex-direction: column;
  align-items: flex-start;
...
`,Xu=()=>f.jsx(Bu,{children:f.jsx(Aa,{children:f.jsxs(Qu,{children:[f.jsxs(Ku,{children:[f.jsx(ns,{}),f.jsx(uu,{})]}),f.jsx(zu,{children:f.jsxs(Vu,{children:[f.jsx(hu,{}),f.jsx(Hu,{})]})})]})})});export{Xu as default};
