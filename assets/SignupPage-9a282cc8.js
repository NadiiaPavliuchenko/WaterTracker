import{u as m,B as b,C as d,J as j,j as o,F as u,D as g,E as c,G as p,s as l,c as f,M as y,K as k,b as $,N as S,r as v,W as N,L as R,O as x,P as C}from"./index-1ac2801a.js";import{b as h,a as F}from"./bottle_mob_2x-8d352aa4.js";import{b as P,a as I,c as B,d as U}from"./bottle_desk_2x-b7d1eae2.js";const z=m.div`
...
`,V=({isModalOpen:e,closeModal:i})=>{const a=b({email:d().email().required()}),n={email:""},r=f(),t=s=>{r(k(s)),i()};return o.jsx(o.Fragment,{children:e&&o.jsx(y,{onClose:i,children:o.jsx(M,{children:o.jsx(u,{initialValues:n,validationSchema:a,onSubmit:t,children:o.jsxs(g,{className:"form",autoComplete:"off",noValidate:!0,children:[o.jsxs("label",{className:"label",htmlFor:"email",children:["Enter your email for re-send code:",o.jsx("br",{}),o.jsx("div",{className:"input-container",children:o.jsx(c,{className:"input",type:"email",name:"email",placeholder:"Email"})}),o.jsx(p,{className:"error",name:"email",component:"div"})]}),o.jsx("button",{type:"submit",children:"Send"})]})})})})})},G=()=>{const e=f(),i=$(S),[a,n]=v.useState(!1),r=()=>{n(!0)},t=()=>{n(!1)};function s(w){e(C(w))}return o.jsxs(o.Fragment,{children:[o.jsx(N,{children:o.jsxs(E,{children:[o.jsxs("div",{className:"wrapper",children:[o.jsxs("div",{className:"formCont",children:[o.jsx("h2",{className:"title",children:"Sign Up"}),o.jsx(_,{submitFunc:s}),o.jsxs("div",{className:"link-container",children:[o.jsx(R,{className:"link",to:"/signin",children:"Sign In"}),o.jsx("button",{className:"link",onClick:r,children:"Re-send code"})]})]}),o.jsxs("picture",{className:"bottle",children:[o.jsx("source",{srcSet:`${P} 1x, ${I} 2x`,media:"(min-width: 1440px)",type:"image/png"}),o.jsx("source",{srcSet:`${B} 1x, ${U} 2x`,media:"(min-width: 768px)",type:"image/png"}),o.jsx("source",{srcSet:`${h} 1x, ${F} 2x`,media:"(min-width: 320px)",type:"image/png"}),o.jsx("img",{className:"bottle",alt:"bottle of water",src:h})]})]}),a&&o.jsx(V,{isModalOpen:a,closeModal:t})]})}),i?o.jsx(x,{to:"/signin"}):o.jsx(x,{to:"/signup"})]})};export{G as default};
