...
`,ct=P.p`
  ...
  line-height: 1.28571;
  color: ${({theme:n})=>n.color.red};
`,Ia=n=>n.water.month,Zr=n=>n.water.dayInfo,$a=n=>{var r;return(r=n.water.dayInfo)==null?void 0:r.consumedWaterPercentage},La=n=>{var r;return(r=n.water.dayInfo)==null?void 0:r.dailyWaterGoal},Fa=n=>n.water.dayDataLoading,ja=({closeModal:n})=>{const t=(ve(La)/1e3).toFixed(1),[e,o]=D.useState(""),[s,a]=D.useState(!0),i=15,c=f=>{const{value:m}=f.target,h=/^(\d+([.,]\d{0,1})?)?$/;var g=m;m.match(/^[.,]/)?g="0"+m:g=m.replace(/^0+([^.])/,"$1"),a(g===""||parseFloat(g.replace(",","."))<=i),h.test(g)&&o(g)},l=Be(),d=async f=>{if(f.preventDefault(),!s||e<=0)return;const m=f.target.elements.dailyNorm.value*1e3;try{const{payload:h}=await l(Yo(m));h.user&&(l(jr()),n())}catch(h){console.log("🚀 ~ error:",h)}};return p.jsxs("form",{onSubmit:d,children:[p.jsxs(Ya,{children:["Write down how much water you will drink:",p.jsx(fn,{className:!s&&e<=0?"error":"",type:"number",name:"dailyNorm",value:e,onChange:c,placeholder:t}),!s&&p.jsx(ct,{children:`The water rate cannot exceed ${i} liters`}),e<0&&p.jsx(ct,{children:"The water rate cannot be negative"}),parseFloat(e)===0&&p.jsx(ct,{children:"The water rate cannot be 0"})]}),p.jsx(Ra,{className:"confirm",type:"submit",children:"Save"})]})},Wa=()=>{const n=ve(Ro),[r,t]=D.useState(n),[e,o]=D.useState(""),[s,a]=D.useState(""),[i,c]=D.useState(!0),[l,d]=D.useState(!0),f=ve(Io)?"dark":"light",h=`radio-${r==="woman"?"active":"inactive"}-${f}`,y=`radio-${r==="man"?"active":"inactive"}-${f}`,x=300,v=12,b=_=>{const{name:O,value:C}=_.target,N=/^(\d+([.,]\d{0,1})?)?$/;var Y=C;switch(O){case"gender":t(C);break;case"weight":C.match(/^[.,]/)?Y="0"+C:Y=C.replace(/^0+([^.])/,"$1"),c(Y===""||parseFloat(Y.replace(",","."))<=x),N.test(Y)&&o(Y);break;case"activeHours":C.match(/^[.,]/)?Y="0"+C:Y=C.replace(/^0+([^.])/,"$1"),d(Y===""||parseFloat(Y.replace(",","."))<=v),N.test(Y)&&a(Y);break}},k=r==="woman"?e*.03+s*.4:e*.04+s*.6,T=Math.round(k*10)/10;return p.jsx("div",{children:p.jsxs("form",{action:"",children:[p.jsx(Pa,{children:"Calculate your rate:"}),p.jsxs(Ta,{children:[p.jsxs(Jn,{children:[p.jsx(er,{id:"woman",type:"radio",name:"gender",value:"woman",checked:r==="woman",onChange:b}),p.jsxs(tr,{htmlFor:"woman",children:[p.jsx(nr,{children:p.jsx(rr,{children:p.jsx("use",{href:`${Le}#${h}`})})}),"For woman"]})]}),p.jsxs(Jn,{children:[p.jsx(er,{id:"man",type:"radio",name:"gender",value:"man",checked:r==="man",onChange:b}),p.jsxs(tr,{htmlFor:"man",children:[p.jsx(nr,{children:p.jsx(rr,{children:p.jsx("use",{href:`${Le}#${y}`})})}),"For man"]})]})]}),p.jsxs(or,{children:["Your weight in kilograms:",p.jsx(fn,{className:i?"":"error",type:"number",name:"weight",value:e,onChange:b,placeholder:"0"}),!i&&p.jsx(ct,{children:`Weight cannot exceed ${x} kg`})]}),p.jsxs(or,{children:["The time of active participation in sports or other activities with a high physical. load in hours:",p.jsx(fn,{className:l?"":"error",type:"number",name:"activeHours",value:s,onChange:b,placeholder:"0"}),!l&&p.jsx(ct,{children:`Active hours cannot exceed ${v} hours`})]}),p.jsxs(Na,{children:[p.jsxs(Oa,{children:["The required amount of water in liters per day:"," "]}),i&&l&&p.jsxs(Ea,{children:[T," L"]})]})]})})},Aa=P.div`
  display: flex;
  flex-direction: column;
  gap: 24px;
...
`,rs="/WaterTrackerFrontend/assets/bottle_tab-881bc7f1.png",os="/WaterTrackerFrontend/assets/bottle_tab_2x-f93ca187.png",as="/WaterTrackerFrontend/assets/bottle_desk-1f4873df.png",ss="/WaterTrackerFrontend/assets/bottle_desk_2x-dc99a824.png",is=()=>{const{dailyWaterGoal:n}=ve($o),[r,t]=D.useState(!1),e=Be(),o=()=>{t(!0)},s=()=>{t(!1)},a=(n/1e3).toFixed(1)+" L";return D.useEffect(()=>{e(jr())},[e]),p.jsxs(Xa,{children:[p.jsxs(Ga,{children:[p.jsx(Za,{children:"My daily norma: "}),p.jsxs(ts,{children:[p.jsx(es,{children:a}),p.jsx(Ja,{onClick:o,children:"Edit"})]}),p.jsx(Ua,{isModalOpen:r,closeModal:s})]}),p.jsxs("picture",{className:"bottle",children:[p.jsx("source",{srcSet:`${as} 1x, ${ss} 2x`,media:"(min-width: 1440px)",width:"738",height:"548",type:"image/png"}),p.jsx("source",{srcSet:`${rs} 1x, ${os} 2x`,media:"(min-width: 768px)",width:"518",height:"386",type:"image/png"}),p.jsx("source",{srcSet:`${Kn} 1x, ${Qo} 2x`,media:"(min-width: 320px)",width:"280",height:"210",type:"image/png"}),p.jsx(ns,{className:"bottle",alt:"bottle of water",src:Kn})]})]})},cs=P.div`
  display: flex;
  height: 90px;
  flex-direction: column;
...
`,Po=({isModalOpen:n,closeModal:r})=>{const[t,e]=D.useState(50),[o,s]=D.useState(new Date),a=Be(),i=()=>{e(m=>m+50)},c=()=>{t>=50&&e(m=>m-50)},l=m=>{s(m)},d=m=>{m.preventDefault();const h=o.getTimezoneOffset();a(Fo({date:o,ml:t,timeZoneOffset:h})),r()},f=m=>{const h=parseInt(m.target.value);e(h)};return p.jsx(p.Fragment,{children:n&&p.jsx(Bt,{onClose:r,children:p.jsxs(fu,{children:[p.jsxs("div",{className:"topline",children:[p.jsx("h2",{children:"Add water"}),p.jsx(Ht,{className:"close",onClick:r})]}),p.jsx("p",{children:"Choose of water:"}),p.jsxs("form",{onSubmit:d,children:[p.jsx("label",{children:"Amount of water:"}),p.jsxs("div",{className:"counter",children:[p.jsx("button",{className:"counterBtn",type:"button",onClick:c,children:p.jsx(In,{})}),p.jsxs("div",{className:"waterAmount",children:[t,"ml"]}),p.jsx("button",{className:"counterBtn",type:"button",onClick:i,children:p.jsx(Yn,{})})]}),p.jsxs("label",{children:["Recording time:",p.jsx(So,{className:"input",selected:o,onChange:m=>l(m),showTimeSelect:!0,showTimeSelectOnly:!0,timeFormat:"HH:mm",dateFormat:"HH:mm"})]}),p.jsxs("label",{children:["Enter the value of the water used:",p.jsx("input",{className:"input",type:"number",value:t,onChange:f})]}),p.jsxs("div",{className:"buttons",children:[p.jsxs("span",{className:"amount",children:[t,"ml"]}),p.jsx("button",{className:"confirm",type:"submit",onClick:d,children:"Save"})]})]})]})})})},hu=()=>{const[n,r]=D.useState(!1),t=ve($a),e=Be(),o=()=>{r(!0)},s=()=>{r(!1)},a=t>100?100:t;return D.useEffect(()=>{e(jo())},[e]),p.jsx(p.Fragment,{children:p.jsxs(cs,{children:[p.jsx("h3",{children:"Today"}),p.jsxs("div",{className:"box",children:[p.jsx(ls,{children:p.jsx("div",{className:"progress-bar-container",children:p.jsxs("div",{className:"progress-bar",children:[p.jsx("div",{className:"progress",style:{width:`${a}%`}}),p.jsx("div",{className:"line-0",children:"|"}),p.jsx("div",{className:"line-50",children:"|"}),p.jsx("div",{className:"line-100",children:"|"}),p.jsx("div",{className:"marker-0",children:"0%"}),p.jsx("div",{className:"marker-50",children:"50%"}),p.jsx("div",{className:"marker-100",children:"100%"}),p.jsx("div",{className:"indicator",style:{left:`${a}%`},children:p.jsx("p",{className:"progress-text",children:t>100?`${t}%`:`${a}%`})})]})})}),p.jsxs(us,{onClick:o,children:[p.jsx(ds,{width:"20px",height:"20px",children:p.jsx("use",{xlinkHref:`${Le}#plus-circle`})})," ",p.jsx("p",{children:"Add Water"})]})]}),n&&p.jsx(Po,{isModalOpen:n,closeModal:s})]})})},mu=P.div`
  *::-webkit-scrollbar {
    width: 4px;
  }
...
`,Gu=P.div`
  ...
  align-items: center;
  position: relative;
`,Zu=({calendarRef:n,day:r,month:t,year:e,dailyWaterGoal:o,consumedWaterPercentage:s,consumedTimes:a})=>{const i=new Date(e,t.monthNumber,r),c=new Date>=i,l=yu(new Date,i),[d,f]=D.useState(null),m=D.useRef(null),h=y=>{m.current&&!m.current.contains(y.target)&&f(null)};D.useEffect(()=>(document.addEventListener("click",h),()=>{document.removeEventListener("click",h)}),[]);const g=()=>{f(y=>y===r?null:r)};return p.jsxs(Gu,{children:[p.jsx("div",{children:d===r&&p.jsx(Wu,{calendarRef:n,refData:m,waterDay:s,day:r,month:t.monthName,dailyWaterGoal:o,consumedWaterPercentage:s,consumedTimes:a},r)}),p.jsx(zu,{ref:m,onClick:()=>g(),$isOutlineVisible:s<100&&c,$isToday:l,children:r}),p.jsx(Uu,{children:`${s}%`})]},r)},Ju=()=>{const[n,r]=D.useState(new Date),t=Be(),e=D.useRef(null),o=ve(Zr),s=ve(Ia),a=ve(Fa);D.useEffect(()=>{const g=n.getTimezoneOffset(),y=new Date(n.getFullYear(),n.getMonth(),1);y.setMinutes(y.getMinutes()-g);const x=new Date(n.getFullYear(),n.getMonth()+1,0);x.setMinutes(x.getMinutes()-g);const v=y.toISOString().split("T")[0],b=x.toISOString().split("T")[0];t(Ho({startDate:v,endDate:b}))},[t,n,o]);const i=()=>{const g=new Date(n.getFullYear(),n.getMonth()+1,1);r(g)},c=()=>{const g=new Date(n.getFullYear(),n.getMonth()-1,1);r(g)},l=()=>{const g=new Date;return n.getMonth()===g.getMonth()&&n.getFullYear()===g.getFullYear()},d=()=>new Date(n.getFullYear(),n.getMonth()+1,0).getDate(),f=()=>{const g=new Date(n).getMonth(),y=new Date(n).toLocaleString("en-US",{month:"long"});return{monthNumber:g,monthName:y}},m=()=>new Date(n).getFullYear(),h=()=>{const g=d(),y=f(),x=m();return Array.from({length:g},(v,b)=>{if(!s)return;const k=b+1,T=s.find(({entryDate:N})=>k===new Date(N).getDate()),_=T?T.consumedWaterPercentage:0,O=T?T.dailyWaterGoal:0,C=T?T.consumedTimes:0;return p.jsx(Zu,{day:k,month:y,year:x,dailyWaterGoal:O,consumedWaterPercentage:_,consumedTimes:C},k)})};return p.jsxs(Au,{className:"calendar",ref:e,children:[p.jsxs(Hu,{children:[p.jsx(Bu,{children:"Month"}),a&&p.jsx(Lu,{height:"60",width:"60",radius:"9",color:dn.colors.blue,ariaLabel:"three-dots-loading",wrapperStyle:{height:"30px",width:"40px",display:"flex",alignItems:"center",justifyContent:"center"},wrapperClassName:"",visible:!0}),p.jsxs(Vu,{children:[p.jsx(Ku,{"aria-label":"Previous month",onClick:c,children:p.jsx(No,{sx:{color:dn.colors.blue}})}),p.jsx(qu,{children:`${new Intl.DateTimeFormat("en-US",{month:"long"}).format(n)}, ${n.getFullYear()}`}),p.jsx(Qu,{"aria-label":"Next month",onClick:i,disabled:l(),hidden:l(),children:p.jsx(To,{sx:{color:dn.colors.blue}})})]})]}),p.jsx(Xu,{children:h()})]})},ed=P.div`
