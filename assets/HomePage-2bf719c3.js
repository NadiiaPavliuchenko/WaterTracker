...
`,Ou=({calendarRef:n,refData:r,day:t,month:e,dailyWaterGoal:o,consumedWaterPercentage:s,consumedTimes:a})=>{const i=`${t}, ${e}`,c=r==null?void 0:r.current.getBoundingClientRect().left,l=n==null?void 0:n.current.getBoundingClientRect().left;let d=!0;const f=c-l;return f<250&&(d=!1),p.jsx(Nu,{$delta:d,$deltaNum:f,children:o!==0?p.jsxs(p.Fragment,{children:[p.jsx("h3",{style:{fontSize:"16px",lineHeight:"calc(20 / 16)"},children:i}),p.jsxs("p",{style:{fontSize:"16px",lineHeight:"calc(20 / 16)"},children:["Daily norma:"," ",p.jsxs("span",{style:{fontSize:"18px",lineHeight:"calc(24 / 18)",fontWeight:"600"},children:[o/1e3," L"]})]}),p.jsxs("p",{style:{fontSize:"16px",lineHeight:"calc(20 / 16)"},children:["Fulfillment of the daily norm:"," ",p.jsxs("span",{style:{fontSize:"18px",lineHeight:"calc(24 / 18)",fontWeight:"600"},children:[s,"%"]})]}),p.jsxs("p",{style:{fontSize:"16px",lineHeight:"calc(20 / 16)"},children:["How many servings of water:"," ",p.jsx("span",{style:{fontSize:"18px",lineHeight:"calc(24 / 18)",fontWeight:"600"},children:a})]})]}):p.jsx("h3",{children:"You dont have records of this day."})})},Eu=P.div`
  display: flex;
  flex-direction: column;
  padding: 24px 0;
  height: 380px;
...
`,Hu=P.div`
  ...
  align-items: center;
  position: relative;
`,Bu=({calendarRef:n,day:r,month:t,year:e,dailyWaterGoal:o,consumedWaterPercentage:s,consumedTimes:a})=>{const i=new Date(e,t.monthNumber,r),c=new Date>=i,l=yu(new Date,i),[d,f]=k.useState(null),m=k.useRef(null),h=y=>{m.current&&!m.current.contains(y.target)&&f(null)};k.useEffect(()=>(document.addEventListener("click",h),()=>{document.removeEventListener("click",h)}),[]);const g=()=>{f(y=>y===r?null:r)};return p.jsxs(Hu,{children:[p.jsx("div",{children:d===r&&p.jsx(Ou,{calendarRef:n,refData:m,waterDay:s,day:r,month:t.monthName,dailyWaterGoal:o,consumedWaterPercentage:s,consumedTimes:a},r)}),p.jsx(Lu,{ref:m,onClick:()=>g(),$isOutlineVisible:s<100&&c,$isToday:l,children:r}),p.jsx(Wu,{children:`${s}%`})]},r)},Qu="#4fa94d",Ku={"aria-busy":!0,role:"progressbar"},zu=P.div`
  display: ${n=>n.$visible?"flex":"none"};
`,Vu="http://www.w3.org/2000/svg",ue=242.776657104492,qu=1.6,Uu=Cn`
12.5% {
...
`;P.path`
  ...
  stroke-dashoffset: 0;
  animation: ${Uu} ${qu}s linear infinite;
`;const Xu=Cn`
to {
   transform: rotate(360deg);
 }
`;P.svg`
  animation: ${Xu} 0.75s steps(12, end) infinite;
...
`;const Gu=({height:n=80,width:r=80,radius:t=9,color:e=Qu,ariaLabel:o="three-dots-loading",wrapperStyle:s,wrapperClass:a,visible:i=!0})=>p.jsx(zu,{style:s,$visible:i,className:a,"data-testid":"three-dots-loading","aria-label":o,...Ku,children:p.jsxs("svg",{width:r,height:n,viewBox:"0 0 120 30",xmlns:Vu,fill:e,"data-testid":"three-dots-svg",children:[p.jsxs("circle",{cx:"15",cy:"15",r:Number(t)+6,children:[p.jsx("animate",{attributeName:"r",from:"15",to:"15",begin:"0s",dur:"0.8s",values:"15;9;15",calcMode:"linear",repeatCount:"indefinite"}),p.jsx("animate",{attributeName:"fill-opacity",from:"1",to:"1",begin:"0s",dur:"0.8s",values:"1;.5;1",calcMode:"linear",repeatCount:"indefinite"})]}),p.jsxs("circle",{cx:"60",cy:"15",r:t,attributeName:"fill-opacity",from:"1",to:"0.3",children:[p.jsx("animate",{attributeName:"r",from:"9",to:"9",begin:"0s",dur:"0.8s",values:"9;15;9",calcMode:"linear",repeatCount:"indefinite"}),p.jsx("animate",{attributeName:"fill-opacity",from:"0.5",to:"0.5",begin:"0s",dur:"0.8s",values:".5;1;.5",calcMode:"linear",repeatCount:"indefinite"})]}),p.jsxs("circle",{cx:"105",cy:"15",r:Number(t)+6,children:[p.jsx("animate",{attributeName:"r",from:"15",to:"15",begin:"0s",dur:"0.8s",values:"15;9;15",calcMode:"linear",repeatCount:"indefinite"}),p.jsx("animate",{attributeName:"fill-opacity",from:"1",to:"1",begin:"0s",dur:"0.8s",values:"1;.5;1",calcMode:"linear",repeatCount:"indefinite"})]})]})}),Zu=Cn`
to {
   stroke-dashoffset: 136;
 }
`;P.polygon`
  stroke-dasharray: 17;
  animation: ${Zu} 2.5s cubic-bezier(0.35, 0.04, 0.63, 0.95) infinite;
`;P.svg`
  transform-origin: 50% 65%;
`;const dn={colors:{white:"#FFFFFF",black:"#2F2F2F",blue:"#407BFF",red:"#EF5050",orange:"#FF9D43",grey:"#ECF2FF",violet:"#9EBBFF",violet_light:"#D7E3FF"},animation:{duration:"0.3s",cubicBezier:"cubic-bezier(0.5, 0, 0.2, 1)"}},Ju=()=>{const[n,r]=k.useState(new Date),t=Be(),e=k.useRef(null),o=ve(Zr),s=ve(Ia),a=ve(Fa);k.useEffect(()=>{const g=n.getTimezoneOffset(),y=new Date(n.getFullYear(),n.getMonth(),1);y.setMinutes(y.getMinutes()-g);const x=new Date(n.getFullYear(),n.getMonth()+1,0);x.setMinutes(x.getMinutes()-g);const v=y.toISOString().split("T")[0],b=x.toISOString().split("T")[0],D={startDate:v,endDate:b};t(Ho(D)),console.log(D)},[t,n,o]);const i=()=>{const g=new Date(n.getFullYear(),n.getMonth()+1,1);r(g)},c=()=>{const g=new Date(n.getFullYear(),n.getMonth()-1,1);r(g)},l=()=>{const g=new Date;return n.getMonth()===g.getMonth()&&n.getFullYear()===g.getFullYear()},d=()=>new Date(n.getFullYear(),n.getMonth()+1,0).getDate(),f=()=>{const g=new Date(n).getMonth(),y=new Date(n).toLocaleString("en-US",{month:"long"});return{monthNumber:g,monthName:y}},m=()=>new Date(n).getFullYear(),h=()=>{const g=d(),y=f(),x=m();return Array.from({length:g},(v,b)=>{if(!s)return;const D=b+1,T=s.find(({entryDate:N})=>D===new Date(N).getDate()),_=T?T.consumedWaterPercentage:0,O=T?T.dailyWaterGoal:0,C=T?T.consumedTimes:0;return p.jsx(Bu,{day:D,month:y,year:x,dailyWaterGoal:O,consumedWaterPercentage:_,consumedTimes:C},D)})};return p.jsxs(Eu,{className:"calendar",ref:e,children:[p.jsxs(Yu,{children:[p.jsx(Ru,{children:"Month"}),a&&p.jsx(Gu,{height:"60",width:"60",radius:"9",color:dn.colors.blue,ariaLabel:"three-dots-loading",wrapperStyle:{height:"30px",width:"40px",display:"flex",alignItems:"center",justifyContent:"center"},wrapperClassName:"",visible:!0}),p.jsxs(Fu,{children:[p.jsx($u,{"aria-label":"Previous month",onClick:c,children:p.jsx(No,{sx:{color:dn.colors.blue}})}),p.jsx(ju,{children:`${new Intl.DateTimeFormat("en-US",{month:"long"}).format(n)}, ${n.getFullYear()}`}),p.jsx(Iu,{"aria-label":"Next month",onClick:i,disabled:l(),hidden:l(),children:p.jsx(To,{sx:{color:dn.colors.blue}})})]})]}),p.jsx(Au,{children:h()})]})},ed=P.div`
