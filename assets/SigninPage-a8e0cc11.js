import{u as h,B as x,C as c,j as o,F as m,D as u,E as p,G as d,s as l,c as b,M as g,H as f,r as w,W as j,L as v,I as y}from"./index-a9f84d30.js";import{b as S,a as k,c as $,d as N}from"./bottle_desk_2x-0e16256e.js";const R=h.div`
...
`,B=({isModalOpen:e,closeModal:n})=>{const a=x({email:c().email().required()}),s={email:""},r=b(),i=t=>{r(f(t)),n()};return o.jsx(o.Fragment,{children:e&&o.jsx(g,{onClose:n,children:o.jsx(C,{children:o.jsx(m,{initialValues:s,validationSchema:a,onSubmit:i,children:o.jsxs(u,{className:"form",autoComplete:"off",noValidate:!0,children:[o.jsxs("label",{className:"label",htmlFor:"email",children:["Enter your registered mail:",o.jsx("br",{}),o.jsx("div",{className:"input-container",children:o.jsx(p,{className:"input",type:"email",name:"email",placeholder:"Email"})}),o.jsx(d,{className:"error",name:"email",component:"div"})]}),o.jsx("button",{type:"submit",children:"Send"})]})})})})})},E=()=>{const e=b(),[n,a]=w.useState(!1),s=()=>{a(!0)},r=()=>{a(!1)};function i(t){e(y(t))}return o.jsx(o.Fragment,{children:o.jsx(z,{children:o.jsxs(j,{children:[o.jsxs("div",{className:"wrapper",children:[o.jsxs("div",{className:"formCont",children:[o.jsx("h2",{className:"title",children:"Sign In"}),o.jsx(F,{submitFunc:i}),o.jsxs("div",{className:"link-container",children:[o.jsx(v,{className:"link",to:"/signup",children:"Sign Up"}),o.jsx("button",{className:"link",onClick:s,children:"Forgot Password"})]})]}),o.jsx("img",{className:"bottle",alt:"bottle of water",src:N})]}),n&&o.jsx(B,{isModalOpen:n,closeModal:r})]})})})};export{E as default};
